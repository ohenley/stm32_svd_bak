...
package STM32_SVD.LTDC is
   ...
   subtype SSCR_VSH_Field is BT.UInt11;
   subtype SSCR_HSW_Field is BT.UInt12;
   ...
   subtype BPCR_AVBP_Field is BT.UInt11;
   subtype BPCR_AHBP_Field is BT.UInt12;
   ...
   subtype AWCR_AAH_Field is BT.UInt11;
   subtype AWCR_AAW_Field is BT.UInt12;
   ...
   subtype TWCR_TOTALH_Field is BT.UInt11;
   subtype TWCR_TOTALW_Field is BT.UInt12;
   ...
   subtype GCR_DBW_Field is BT.UInt3;
   subtype GCR_DGW_Field is BT.UInt3;
   subtype GCR_DRW_Field is BT.UInt3;
   ...
   type GCR_Register is record
      ...
      --  unspecified
      Reserved_11_11 : BT.Bit := 16#0#;
      --  Read-only. Dither Red Width
      DRW            : GCR_DRW_Field := 16#2#;
      --  unspecified
      Reserved_15_15 : BT.Bit := 16#0#;
      --  Dither Enable
      DEN            : Boolean := False;
      --  unspecified
      Reserved_17_27 : BT.UInt11 := 16#0#;
   ...
   subtype BCCR_BC_Field is BT.UInt24;
   ...
   subtype LIPCR_LIPOS_Field is BT.UInt11;
   ...
   subtype CPSR_CYPOS_Field is BT.UInt16;
   subtype CPSR_CXPOS_Field is BT.UInt16;
   ...
   subtype L1WHPCR_WHSTPOS_Field is BT.UInt12;
   subtype L1WHPCR_WHSPPOS_Field is BT.UInt12;
   ...
   subtype L1WVPCR_WVSTPOS_Field is BT.UInt11;
   subtype L1WVPCR_WVSPPOS_Field is BT.UInt11;
   ...
   subtype L1CKCR_CKBLUE_Field is BT.UInt8;
   subtype L1CKCR_CKGREEN_Field is BT.UInt8;
   subtype L1CKCR_CKRED_Field is BT.UInt8;
   ...
   subtype L1PFCR_PF_Field is BT.UInt3;
   ...
   subtype L1CACR_CONSTA_Field is BT.UInt8;
   ...
   subtype L1DCCR_DCBLUE_Field is BT.UInt8;
   subtype L1DCCR_DCGREEN_Field is BT.UInt8;
   subtype L1DCCR_DCRED_Field is BT.UInt8;
   subtype L1DCCR_DCALPHA_Field is BT.UInt8;
   ...
   subtype L1BFCR_BF2_Field is BT.UInt3;
   subtype L1BFCR_BF1_Field is BT.UInt3;
   ...
   subtype L1CFBLR_CFBLL_Field is BT.UInt13;
   subtype L1CFBLR_CFBP_Field is BT.UInt13;
   ...
   subtype L1CFBLNR_CFBLNBR_Field is BT.UInt11;
   ...
   subtype L1CLUTWR_BLUE_Field is BT.UInt8;
   subtype L1CLUTWR_GREEN_Field is BT.UInt8;
   subtype L1CLUTWR_RED_Field is BT.UInt8;
   subtype L1CLUTWR_CLUTADD_Field is BT.UInt8;
   ...
   subtype L2WHPCR_WHSTPOS_Field is BT.UInt12;
   subtype L2WHPCR_WHSPPOS_Field is BT.UInt12;
   ...
   subtype L2WVPCR_WVSTPOS_Field is BT.UInt11;
   subtype L2WVPCR_WVSPPOS_Field is BT.UInt11;
   ...
   subtype L2CKCR_CKBLUE_Field is BT.UInt8;
   subtype L2CKCR_CKGREEN_Field is BT.UInt7;
   subtype L2CKCR_CKRED_Field is BT.UInt9;
   ...
   subtype L2PFCR_PF_Field is BT.UInt3;
   ...
   subtype L2CACR_CONSTA_Field is BT.UInt8;
   ...
   subtype L2DCCR_DCBLUE_Field is BT.UInt8;
   subtype L2DCCR_DCGREEN_Field is BT.UInt8;
   subtype L2DCCR_DCRED_Field is BT.UInt8;
   subtype L2DCCR_DCALPHA_Field is BT.UInt8;
   ...
   subtype L2BFCR_BF2_Field is BT.UInt3;
   subtype L2BFCR_BF1_Field is BT.UInt3;
   ...
   subtype L2CFBLR_CFBLL_Field is BT.UInt13;
   subtype L2CFBLR_CFBP_Field is BT.UInt13;
   ...
   subtype L2CFBLNR_CFBLNBR_Field is BT.UInt11;
   ...
   subtype L2CLUTWR_BLUE_Field is BT.UInt8;
   subtype L2CLUTWR_GREEN_Field is BT.UInt8;
   subtype L2CLUTWR_RED_Field is BT.UInt8;
   subtype L2CLUTWR_CLUTADD_Field is BT.UInt8;
