...
package STM32_SVD.PWR is
   ...
   subtype CR_PLS_Field is BT.UInt3;
   subtype CR_VOS_Field is BT.UInt2;
   subtype CR_UDEN_Field is BT.UInt2;
   ...
   subtype CSR_UDRDY_Field is BT.UInt2;
