...
package STM32_SVD.SDIO is
   ...
   subtype POWER_PWRCTRL_Field is BT.UInt2;
   ...
   subtype CLKCR_CLKDIV_Field is BT.UInt8;
   subtype CLKCR_WIDBUS_Field is BT.UInt2;
   ...
   subtype CMD_CMDINDEX_Field is BT.UInt6;
   subtype CMD_WAITRESP_Field is BT.UInt2;
   ...
   subtype RESPCMD_RESPCMD_Field is BT.UInt6;
   ...
   subtype DLEN_DATALENGTH_Field is BT.UInt25;
   ...
   subtype DCTRL_DBLOCKSIZE_Field is BT.UInt4;
   ...
   subtype DCOUNT_DATACOUNT_Field is BT.UInt25;
   ...
   subtype FIFOCNT_FIFOCOUNT_Field is BT.UInt24;
   ...
   type SDIO_Peripheral is record
      ...
      --  argument register
      ARG     : aliased BT.UInt32;
      --  command register
      CMD     : aliased CMD_Register;
      --  command response register
      RESPCMD : aliased RESPCMD_Register;
      --  response 1..4 register
      RESP1   : aliased BT.UInt32;
      --  response 1..4 register
      RESP2   : aliased BT.UInt32;
      --  response 1..4 register
      RESP3   : aliased BT.UInt32;
      --  response 1..4 register
      RESP4   : aliased BT.UInt32;
      --  data timer register
      DTIMER  : aliased BT.UInt32;
      --  data length register
