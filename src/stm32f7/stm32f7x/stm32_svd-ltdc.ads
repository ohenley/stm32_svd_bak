...
package STM32_SVD.LTDC is
   ...
   subtype SSCR_VSH_Field is Beta_Types.UInt11;
   subtype SSCR_HSW_Field is Beta_Types.UInt10;
   ...
   subtype BPCR_AVBP_Field is Beta_Types.UInt11;
   subtype BPCR_AHBP_Field is Beta_Types.UInt10;
   ...
   subtype AWCR_AAH_Field is Beta_Types.UInt11;
   subtype AWCR_AAW_Field is Beta_Types.UInt10;
   ...
   subtype TWCR_TOTALH_Field is Beta_Types.UInt11;
   subtype TWCR_TOTALW_Field is Beta_Types.UInt10;
   ...
   subtype GCR_DBW_Field is Beta_Types.UInt3;
   subtype GCR_DGW_Field is Beta_Types.UInt3;
   subtype GCR_DRW_Field is Beta_Types.UInt3;
   ...
   type GCR_Register is record
      ...
      --  unspecified
      Reserved_1_3   : Beta_Types.UInt3 := 16#0#;
      ...
      --  unspecified
      Reserved_11_11 : Beta_Types.Bit := 16#0#;
      ...
      DEN            : Boolean := False;
      --  unspecified
      Reserved_17_27 : Beta_Types.UInt11 := 16#0#;
   ...
   subtype BCCR_BC_Field is Beta_Types.UInt24;
   ...
   type ISR_Register is record
      ...
      RRIF          : Boolean;
      --  unspecified
      Reserved_4_31 : Beta_Types.UInt28;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype LIPCR_LIPOS_Field is Beta_Types.UInt11;
   ...
   subtype CPSR_CYPOS_Field is Beta_Types.UInt16;
   subtype CPSR_CXPOS_Field is Beta_Types.UInt16;
   ...
   subtype L1WHPCR_WHSTPOS_Field is Beta_Types.UInt12;
   subtype L1WHPCR_WHSPPOS_Field is Beta_Types.UInt12;
   ...
   subtype L1WVPCR_WVSTPOS_Field is Beta_Types.UInt11;
   subtype L1WVPCR_WVSPPOS_Field is Beta_Types.UInt11;
   ...
   subtype L1CKCR_CKBLUE_Field is Beta_Types.UInt8;
   subtype L1CKCR_CKGREEN_Field is Beta_Types.UInt8;
   subtype L1CKCR_CKRED_Field is Beta_Types.UInt8;
   ...
   subtype L1PFCR_PF_Field is Beta_Types.UInt3;
   ...
   subtype L1CACR_CONSTA_Field is Beta_Types.UInt8;
   ...
   subtype L1DCCR_DCBLUE_Field is Beta_Types.UInt8;
   subtype L1DCCR_DCGREEN_Field is Beta_Types.UInt8;
   subtype L1DCCR_DCRED_Field is Beta_Types.UInt8;
   subtype L1DCCR_DCALPHA_Field is Beta_Types.UInt8;
   ...
   subtype L1BFCR_BF2_Field is Beta_Types.UInt3;
   subtype L1BFCR_BF1_Field is Beta_Types.UInt3;
   ...
   subtype L1CFBLR_CFBLL_Field is Beta_Types.UInt13;
   subtype L1CFBLR_CFBP_Field is Beta_Types.UInt13;
   ...
   subtype L1CFBLNR_CFBLNBR_Field is Beta_Types.UInt11;
   ...
   subtype L1CLUTWR_BLUE_Field is Beta_Types.UInt8;
   subtype L1CLUTWR_GREEN_Field is Beta_Types.UInt8;
   subtype L1CLUTWR_RED_Field is Beta_Types.UInt8;
   subtype L1CLUTWR_CLUTADD_Field is Beta_Types.UInt8;
   ...
   subtype L2WHPCR_WHSTPOS_Field is Beta_Types.UInt12;
   subtype L2WHPCR_WHSPPOS_Field is Beta_Types.UInt12;
   ...
   subtype L2WVPCR_WVSTPOS_Field is Beta_Types.UInt11;
   subtype L2WVPCR_WVSPPOS_Field is Beta_Types.UInt11;
   ...
   subtype L2CKCR_CKBLUE_Field is Beta_Types.UInt8;
   subtype L2CKCR_CKGREEN_Field is Beta_Types.UInt7;
   subtype L2CKCR_CKRED_Field is Beta_Types.UInt9;
   ...
   subtype L2PFCR_PF_Field is Beta_Types.UInt3;
   ...
   subtype L2CACR_CONSTA_Field is Beta_Types.UInt8;
   ...
   subtype L2DCCR_DCBLUE_Field is Beta_Types.UInt8;
   subtype L2DCCR_DCGREEN_Field is Beta_Types.UInt8;
   subtype L2DCCR_DCRED_Field is Beta_Types.UInt8;
   subtype L2DCCR_DCALPHA_Field is Beta_Types.UInt8;
   ...
   subtype L2BFCR_BF2_Field is Beta_Types.UInt3;
   subtype L2BFCR_BF1_Field is Beta_Types.UInt3;
   ...
   subtype L2CFBLR_CFBLL_Field is Beta_Types.UInt13;
   subtype L2CFBLR_CFBP_Field is Beta_Types.UInt13;
   ...
   subtype L2CFBLNR_CFBLNBR_Field is Beta_Types.UInt11;
   ...
   subtype L2CLUTWR_BLUE_Field is Beta_Types.UInt8;
   subtype L2CLUTWR_GREEN_Field is Beta_Types.UInt8;
   subtype L2CLUTWR_RED_Field is Beta_Types.UInt8;
   subtype L2CLUTWR_CLUTADD_Field is Beta_Types.UInt8;
   ...
   type LTDC_Peripheral is record
      ...
      L1CFBAR  : aliased Beta_Types.UInt32;
      --  Layerx Color Frame Buffer Length Register
      ...
      --  Layerx Color Frame Buffer Address Register
      L2CFBAR  : aliased Beta_Types.UInt32;
      --  Layerx Color Frame Buffer Length Register
