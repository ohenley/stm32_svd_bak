...
package STM32_SVD.I2C is
   ...
   subtype CR1_DNF_Field is Beta_Types.UInt4;
   ...
   subtype CR2_SADD_Field is Beta_Types.UInt10;
   subtype CR2_NBYTES_Field is Beta_Types.UInt8;
   ...
   subtype OAR1_OA1_Field is Beta_Types.UInt10;
   ...
   subtype OAR2_OA2_Field is Beta_Types.UInt7;
   subtype OAR2_OA2MSK_Field is Beta_Types.UInt3;
   ...
   subtype TIMINGR_SCLL_Field is Beta_Types.UInt8;
   subtype TIMINGR_SCLH_Field is Beta_Types.UInt8;
   subtype TIMINGR_SDADEL_Field is Beta_Types.UInt4;
   subtype TIMINGR_SCLDEL_Field is Beta_Types.UInt4;
   subtype TIMINGR_PRESC_Field is Beta_Types.UInt4;
   ...
   type TIMINGR_Register is record
      ...
      --  unspecified
      Reserved_24_27 : Beta_Types.UInt4 := 16#0#;
      --  Timing prescaler
   ...
   subtype TIMEOUTR_TIMEOUTA_Field is Beta_Types.UInt12;
   subtype TIMEOUTR_TIMEOUTB_Field is Beta_Types.UInt12;
   ...
   type TIMEOUTR_Register is record
      ...
      --  unspecified
      Reserved_28_30 : Beta_Types.UInt3 := 16#0#;
   ...
   subtype ISR_ADDCODE_Field is Beta_Types.UInt7;
   ...
   subtype PECR_PEC_Field is Beta_Types.UInt8;
   ...
   type PECR_Register is record
      ...
      PEC           : PECR_PEC_Field;
      --  unspecified
      Reserved_8_31 : Beta_Types.UInt24;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RXDR_RXDATA_Field is Beta_Types.UInt8;
   ...
   subtype TXDR_TXDATA_Field is Beta_Types.UInt8;
