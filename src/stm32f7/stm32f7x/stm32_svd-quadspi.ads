...
package STM32_SVD.QUADSPI is
   ...
   subtype CR_FTHRES_Field is Beta_Types.UInt5;
   subtype CR_PRESCALER_Field is Beta_Types.UInt8;
   ...
   type CR_Register is record
      ...
      TOIE           : Boolean := False;
      --  unspecified
      Reserved_21_21 : Beta_Types.Bit := 16#0#;
   ...
   subtype DCR_CSHT_Field is Beta_Types.UInt3;
   subtype DCR_FSIZE_Field is Beta_Types.UInt5;
   ...
   subtype SR_FLEVEL_Field is Beta_Types.UInt7;
   ...
   type SR_Register is record
      ...
      --  unspecified
      Reserved_15_31 : Beta_Types.UInt17;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CCR_INSTRUCTION_Field is Beta_Types.UInt8;
   subtype CCR_IMODE_Field is Beta_Types.UInt2;
   subtype CCR_ADMODE_Field is Beta_Types.UInt2;
   subtype CCR_ADSIZE_Field is Beta_Types.UInt2;
   subtype CCR_ABMODE_Field is Beta_Types.UInt2;
   subtype CCR_ABSIZE_Field is Beta_Types.UInt2;
   subtype CCR_DCYC_Field is Beta_Types.UInt5;
   subtype CCR_DMODE_Field is Beta_Types.UInt2;
   subtype CCR_FMODE_Field is Beta_Types.UInt2;
   ...
   subtype PIR_INTERVAL_Field is Beta_Types.UInt16;
   ...
   subtype LPTR_TIMEOUT_Field is Beta_Types.UInt16;
   ...
   type QUADSPI_Peripheral is record
      ...
      DLR   : aliased Beta_Types.UInt32;
      --  communication configuration register
      CCR   : aliased CCR_Register;
      --  address register
      AR    : aliased Beta_Types.UInt32;
      --  ABR
      ABR   : aliased Beta_Types.UInt32;
      --  data register
      DR    : aliased Beta_Types.UInt32;
      --  polling status mask register
      PSMKR : aliased Beta_Types.UInt32;
      --  polling status match register
      PSMAR : aliased Beta_Types.UInt32;
      --  polling interval register
