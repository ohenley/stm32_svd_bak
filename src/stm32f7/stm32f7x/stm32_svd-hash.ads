...
package STM32_SVD.HASH is
   ...
   subtype CR_DATATYPE_Field is Beta_Types.UInt2;
   subtype CR_NBW_Field is Beta_Types.UInt4;
   ...
   type CR_Register is record
      ...
      MDMAT          : Boolean := False;
      --  unspecified
      Reserved_14_15 : Beta_Types.UInt2 := 16#0#;
      --  Long key selection
      LKEY           : Boolean := False;
      --  unspecified
   ...
   subtype STR_NBLW_Field is Beta_Types.UInt5;
   ...
   type HASH_Peripheral is record
      ...
      --  data input register
      DIN      : aliased Beta_Types.UInt32;
      --  start register
      STR      : aliased STR_Register;
      --  digest registers
      HR0      : aliased Beta_Types.UInt32;
      --  digest registers
      HR1      : aliased Beta_Types.UInt32;
      --  digest registers
      HR2      : aliased Beta_Types.UInt32;
      --  digest registers
      HR3      : aliased Beta_Types.UInt32;
      --  digest registers
      HR4      : aliased Beta_Types.UInt32;
      --  interrupt enable register
      IMR      : aliased IMR_Register;
      --  status register
      SR       : aliased SR_Register;
      --  context swap registers
      CSR0     : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR1     : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR2     : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR3     : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR4     : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR5     : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR6     : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR7     : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR8     : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR9     : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR10    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR11    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR12    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR13    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR14    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR15    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR16    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR17    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR18    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR19    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR20    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR21    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR22    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR23    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR24    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR25    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR26    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR27    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR28    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR29    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR30    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR31    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR32    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR33    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR34    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR35    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR36    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR37    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR38    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR39    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR40    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR41    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR42    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR43    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR44    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR45    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR46    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR47    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR48    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR49    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR50    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR51    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR52    : aliased Beta_Types.UInt32;
      --  context swap registers
      CSR53    : aliased Beta_Types.UInt32;
      --  HASH digest register
      HASH_HR0 : aliased Beta_Types.UInt32;
      --  read-only
      HASH_HR1 : aliased Beta_Types.UInt32;
      --  read-only
      HASH_HR2 : aliased Beta_Types.UInt32;
      --  read-only
      HASH_HR3 : aliased Beta_Types.UInt32;
      --  read-only
      HASH_HR4 : aliased Beta_Types.UInt32;
      --  read-only
      HASH_HR5 : aliased Beta_Types.UInt32;
      --  read-only
      HASH_HR6 : aliased Beta_Types.UInt32;
      --  read-only
      HASH_HR7 : aliased Beta_Types.UInt32;
   end record
     with Volatile;
