...
package STM32_SVD.CEC is
   ...
   subtype CFGR_SFT_Field is Beta_Types.UInt3;
   subtype CFGR_OAR_Field is Beta_Types.UInt15;
   ...
   subtype TXDR_TXD_Field is Beta_Types.UInt8;
   ...
   subtype RXDR_RXDR_Field is Beta_Types.UInt8;
