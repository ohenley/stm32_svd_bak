...
package STM32_SVD.SAI is
   ...
   subtype GCR_SYNCIN_Field is Beta_Types.UInt2;
   subtype GCR_SYNCOUT_Field is Beta_Types.UInt2;
   ...
   subtype ACR1_MODE_Field is Beta_Types.UInt2;
   subtype ACR1_PRTCFG_Field is Beta_Types.UInt2;
   subtype ACR1_DS_Field is Beta_Types.UInt3;
   subtype ACR1_SYNCEN_Field is Beta_Types.UInt2;
   subtype ACR1_MCJDIV_Field is Beta_Types.UInt4;
   ...
   type ACR1_Register is record
      ...
      --  unspecified
      Reserved_4_4   : Beta_Types.Bit := 16#0#;
      --  Data size
      ...
      DMAEN          : Boolean := False;
      --  unspecified
      Reserved_18_18 : Beta_Types.Bit := 16#0#;
      --  No divider
      NODIV          : Boolean := False;
   ...
   subtype ACR2_FTH_Field is Beta_Types.UInt3;
   subtype ACR2_MUTECN_Field is Beta_Types.UInt6;
   subtype ACR2_COMP_Field is Beta_Types.UInt2;
   ...
   subtype AFRCR_FRL_Field is Beta_Types.UInt8;
   subtype AFRCR_FSALL_Field is Beta_Types.UInt7;
   ...
   subtype ASLOTR_FBOFF_Field is Beta_Types.UInt5;
   subtype ASLOTR_SLOTSZ_Field is Beta_Types.UInt2;
   subtype ASLOTR_NBSLOT_Field is Beta_Types.UInt4;
   subtype ASLOTR_SLOTEN_Field is Beta_Types.UInt16;
   ...
   subtype ASR_FLVL_Field is Beta_Types.UInt3;
   ...
   subtype BCR1_MODE_Field is Beta_Types.UInt2;
   subtype BCR1_PRTCFG_Field is Beta_Types.UInt2;
   subtype BCR1_DS_Field is Beta_Types.UInt3;
   subtype BCR1_SYNCEN_Field is Beta_Types.UInt2;
   subtype BCR1_MCJDIV_Field is Beta_Types.UInt4;
   ...
   subtype BCR2_FTH_Field is Beta_Types.UInt3;
   subtype BCR2_MUTECN_Field is Beta_Types.UInt6;
   subtype BCR2_COMP_Field is Beta_Types.UInt2;
   ...
   subtype BFRCR_FRL_Field is Beta_Types.UInt8;
   subtype BFRCR_FSALL_Field is Beta_Types.UInt7;
   ...
   subtype BSLOTR_FBOFF_Field is Beta_Types.UInt5;
   subtype BSLOTR_SLOTSZ_Field is Beta_Types.UInt2;
   subtype BSLOTR_NBSLOT_Field is Beta_Types.UInt4;
   subtype BSLOTR_SLOTEN_Field is Beta_Types.UInt16;
   ...
   subtype BSR_FLVL_Field is Beta_Types.UInt3;
   ...
   type BSR_Register is record
      ...
      LFSDET         : Boolean;
      --  unspecified
      Reserved_7_15  : Beta_Types.UInt9;
      --  Read-only. FIFO level threshold
      FLVL           : BSR_FLVL_Field;
      --  unspecified
      Reserved_19_31 : Beta_Types.UInt13;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
