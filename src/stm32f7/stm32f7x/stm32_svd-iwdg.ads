...
package STM32_SVD.IWDG is
   ...
   subtype KR_KEY_Field is Beta_Types.UInt16;
   ...
   subtype PR_PR_Field is Beta_Types.UInt3;
   ...
   subtype RLR_RL_Field is Beta_Types.UInt12;
   ...
   subtype WINR_WIN_Field is Beta_Types.UInt12;
