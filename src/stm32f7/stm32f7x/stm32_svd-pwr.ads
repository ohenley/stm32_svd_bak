...
package STM32_SVD.PWR is
   ...
   subtype CR1_PLS_Field is Beta_Types.UInt3;
   subtype CR1_VOS_Field is Beta_Types.UInt2;
   subtype CR1_UDEN_Field is Beta_Types.UInt2;
   ...
   subtype CSR1_UDRDY_Field is Beta_Types.UInt2;
