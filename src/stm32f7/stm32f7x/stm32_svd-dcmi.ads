...
package STM32_SVD.DCMI is
   ...
   subtype CR_FCRC_Field is Beta_Types.UInt2;
   subtype CR_EDM_Field is Beta_Types.UInt2;
   ...
   type SR_Register is record
      ...
      FNE           : Boolean;
      --  unspecified
      Reserved_3_31 : Beta_Types.UInt29;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype ESCR_FSC_Field is Beta_Types.UInt8;
   subtype ESCR_LSC_Field is Beta_Types.UInt8;
   subtype ESCR_LEC_Field is Beta_Types.UInt8;
   subtype ESCR_FEC_Field is Beta_Types.UInt8;
   ...
   subtype ESUR_FSU_Field is Beta_Types.UInt8;
   subtype ESUR_LSU_Field is Beta_Types.UInt8;
   subtype ESUR_LEU_Field is Beta_Types.UInt8;
   subtype ESUR_FEU_Field is Beta_Types.UInt8;
   ...
   subtype CWSTRT_HOFFCNT_Field is Beta_Types.UInt14;
   subtype CWSTRT_VST_Field is Beta_Types.UInt13;
   ...
   subtype CWSIZE_CAPCNT_Field is Beta_Types.UInt14;
   subtype CWSIZE_VLINE_Field is Beta_Types.UInt14;
   ...
   subtype DR_Byte_Element is Beta_Types.UInt8;
