...
package STM32_SVD.CAN is
   ...
   type MCR_Register is record
      ...
      TTCM           : Boolean := False;
      --  unspecified
      Reserved_8_14  : Beta_Types.UInt7 := 16#0#;
      --  RESET
      RESET          : Boolean := False;
      --  DBF
      DBF            : Boolean := True;
   ...
   subtype TSR_CODE_Field is Beta_Types.UInt2;
   ...
   type TSR_Register is record
      ...
      TERR1          : Boolean := False;
      --  unspecified
      Reserved_12_14 : Beta_Types.UInt3 := 16#0#;
      --  ABRQ1
      ABRQ1          : Boolean := False;
      --  RQCP2
      RQCP2          : Boolean := False;
      ...
      TERR2          : Boolean := False;
      --  unspecified
      Reserved_20_22 : Beta_Types.UInt3 := 16#0#;
      --  ABRQ2
      ABRQ2          : Boolean := False;
      --  Read-only. CODE
   ...
   subtype RF0R_FMP0_Field is Beta_Types.UInt2;
   ...
   subtype RF1R_FMP1_Field is Beta_Types.UInt2;
   ...
   subtype ESR_LEC_Field is Beta_Types.UInt3;
   subtype ESR_TEC_Field is Beta_Types.UInt8;
   subtype ESR_REC_Field is Beta_Types.UInt8;
   ...
   type ESR_Register is record
      ...
      --  unspecified
      Reserved_7_15 : Beta_Types.UInt9 := 16#0#;
      --  Read-only. TEC
   ...
   subtype BTR_BRP_Field is Beta_Types.UInt10;
   subtype BTR_TS1_Field is Beta_Types.UInt4;
   subtype BTR_TS2_Field is Beta_Types.UInt3;
   subtype BTR_SJW_Field is Beta_Types.UInt2;
   ...
   type BTR_Register is record
      ...
      --  unspecified
      Reserved_10_15 : Beta_Types.UInt6 := 16#0#;
      --  TS1
      ...
      --  unspecified
      Reserved_26_29 : Beta_Types.UInt4 := 16#0#;
      --  LBKM
      LBKM           : Boolean := False;
      --  SILM
      SILM           : Boolean := False;
   ...
   subtype TI0R_EXID_Field is Beta_Types.UInt18;
   subtype TI0R_STID_Field is Beta_Types.UInt11;
   ...
   subtype TDT0R_DLC_Field is Beta_Types.UInt4;
   subtype TDT0R_TIME_Field is Beta_Types.UInt16;
   ...
   type TDT0R_Register is record
      ...
      --  unspecified
      Reserved_4_7  : Beta_Types.UInt4 := 16#0#;
      --  TGT
      TGT           : Boolean := False;
      --  unspecified
      Reserved_9_15 : Beta_Types.UInt7 := 16#0#;
      --  TIME
   ...
   subtype TDL0R_DATA_Element is Beta_Types.UInt8;
   ...
   subtype TDH0R_DATA_Element is Beta_Types.UInt8;
   ...
   subtype TI1R_EXID_Field is Beta_Types.UInt18;
   subtype TI1R_STID_Field is Beta_Types.UInt11;
   ...
   subtype TDT1R_DLC_Field is Beta_Types.UInt4;
   subtype TDT1R_TIME_Field is Beta_Types.UInt16;
   ...
   subtype TDL1R_DATA_Element is Beta_Types.UInt8;
   ...
   subtype TDH1R_DATA_Element is Beta_Types.UInt8;
   ...
   subtype TI2R_EXID_Field is Beta_Types.UInt18;
   subtype TI2R_STID_Field is Beta_Types.UInt11;
   ...
   subtype TDT2R_DLC_Field is Beta_Types.UInt4;
   subtype TDT2R_TIME_Field is Beta_Types.UInt16;
   ...
   subtype TDL2R_DATA_Element is Beta_Types.UInt8;
   ...
   subtype TDH2R_DATA_Element is Beta_Types.UInt8;
   ...
   subtype RI0R_EXID_Field is Beta_Types.UInt18;
   subtype RI0R_STID_Field is Beta_Types.UInt11;

   --  receive FIFO mailbox identifier register
   type RI0R_Register is record
      --  unspecified
      Reserved_0_0 : Beta_Types.Bit;
      --  Read-only. RTR
      RTR          : Boolean;
      --  Read-only. IDE
      IDE          : Boolean;
   ...
   subtype RDT0R_DLC_Field is Beta_Types.UInt4;
   subtype RDT0R_FMI_Field is Beta_Types.UInt8;
   subtype RDT0R_TIME_Field is Beta_Types.UInt16;
   ...
   subtype RDL0R_DATA_Element is Beta_Types.UInt8;
   ...
   subtype RDH0R_DATA_Element is Beta_Types.UInt8;
   ...
   subtype RI1R_EXID_Field is Beta_Types.UInt18;
   subtype RI1R_STID_Field is Beta_Types.UInt11;
   ...
   subtype RDT1R_DLC_Field is Beta_Types.UInt4;
   subtype RDT1R_FMI_Field is Beta_Types.UInt8;
   subtype RDT1R_TIME_Field is Beta_Types.UInt16;
   ...
   subtype RDL1R_DATA_Element is Beta_Types.UInt8;
   ...
   subtype RDH1R_DATA_Element is Beta_Types.UInt8;
   ...
   subtype FMR_CAN2SB_Field is Beta_Types.UInt6;
   ...
   type FMR_Register is record
      ...
      --  unspecified
      Reserved_14_31 : Beta_Types.UInt18 := 16#A870#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
