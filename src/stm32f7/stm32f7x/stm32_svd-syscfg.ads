...
package STM32_SVD.SYSCFG is
   ...
   subtype MEMRM_MEM_MODE_Field is Beta_Types.UInt3;
   subtype MEMRM_SWP_FMC_Field is Beta_Types.UInt2;
   ...
   type PMC_Register is record
      ...
      --  unspecified
      Reserved_19_22 : Beta_Types.UInt4 := 16#0#;
   ...
   subtype EXTICR1_EXTI_Element is Beta_Types.UInt4;
   ...
   subtype EXTICR2_EXTI_Element is Beta_Types.UInt4;
   ...
   subtype EXTICR3_EXTI_Element is Beta_Types.UInt4;
   ...
   subtype EXTICR4_EXTI_Element is Beta_Types.UInt4;
