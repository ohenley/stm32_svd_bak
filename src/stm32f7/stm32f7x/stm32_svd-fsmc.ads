...
package STM32_SVD.FSMC is
   ...
   subtype BCR1_MTYP_Field is Beta_Types.UInt2;
   subtype BCR1_MWID_Field is Beta_Types.UInt2;
   ...
   type BCR1_Register is record
      ...
      FACCEN         : Boolean := True;
      --  unspecified
      Reserved_7_7   : Beta_Types.Bit := 16#1#;
      --  BURSTEN
      ...
      --  unspecified
      Reserved_16_18 : Beta_Types.UInt3 := 16#0#;
      --  CBURSTRW
   ...
   subtype BTR_ADDSET_Field is Beta_Types.UInt4;
   subtype BTR_ADDHLD_Field is Beta_Types.UInt4;
   subtype BTR_DATAST_Field is Beta_Types.UInt8;
   subtype BTR_BUSTURN_Field is Beta_Types.UInt4;
   subtype BTR_CLKDIV_Field is Beta_Types.UInt4;
   subtype BTR_DATLAT_Field is Beta_Types.UInt4;
   subtype BTR_ACCMOD_Field is Beta_Types.UInt2;
   ...
   type BTR_Register is record
      ...
      --  unspecified
      Reserved_30_31 : Beta_Types.UInt2 := 16#3#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype BCR_MTYP_Field is Beta_Types.UInt2;
   subtype BCR_MWID_Field is Beta_Types.UInt2;
   ...
   subtype PCR_PWID_Field is Beta_Types.UInt2;
   subtype PCR_TCLR_Field is Beta_Types.UInt4;
   subtype PCR_TAR_Field is Beta_Types.UInt4;
   subtype PCR_ECCPS_Field is Beta_Types.UInt3;
   ...
   subtype PMEM_MEMSETx_Field is Beta_Types.UInt8;
   subtype PMEM_MEMWAITx_Field is Beta_Types.UInt8;
   subtype PMEM_MEMHOLDx_Field is Beta_Types.UInt8;
   subtype PMEM_MEMHIZx_Field is Beta_Types.UInt8;
   ...
   subtype PATT_ATTSETx_Field is Beta_Types.UInt8;
   subtype PATT_ATTWAITx_Field is Beta_Types.UInt8;
   subtype PATT_ATTHOLDx_Field is Beta_Types.UInt8;
   subtype PATT_ATTHIZx_Field is Beta_Types.UInt8;
   ...
   subtype BWTR_ADDSET_Field is Beta_Types.UInt4;
   subtype BWTR_ADDHLD_Field is Beta_Types.UInt4;
   subtype BWTR_DATAST_Field is Beta_Types.UInt8;
   subtype BWTR_CLKDIV_Field is Beta_Types.UInt4;
   subtype BWTR_DATLAT_Field is Beta_Types.UInt4;
   subtype BWTR_ACCMOD_Field is Beta_Types.UInt2;
   ...
   type BWTR_Register is record
      ...
      --  unspecified
      Reserved_16_19 : Beta_Types.UInt4 := 16#F#;
      --  CLKDIV
   ...
   subtype SDCR_NC_Field is Beta_Types.UInt2;
   subtype SDCR_NR_Field is Beta_Types.UInt2;
   subtype SDCR_MWID_Field is Beta_Types.UInt2;
   subtype SDCR_CAS_Field is Beta_Types.UInt2;
   subtype SDCR_SDCLK_Field is Beta_Types.UInt2;
   subtype SDCR_RPIPE_Field is Beta_Types.UInt2;
   ...
   subtype SDTR_TMRD_Field is Beta_Types.UInt4;
   subtype SDTR_TXSR_Field is Beta_Types.UInt4;
   subtype SDTR_TRAS_Field is Beta_Types.UInt4;
   subtype SDTR_TRC_Field is Beta_Types.UInt4;
   subtype SDTR_TWR_Field is Beta_Types.UInt4;
   subtype SDTR_TRP_Field is Beta_Types.UInt4;
   subtype SDTR_TRCD_Field is Beta_Types.UInt4;
   ...
   subtype SDCMR_MODE_Field is Beta_Types.UInt3;
   subtype SDCMR_NRFS_Field is Beta_Types.UInt4;
   subtype SDCMR_MRD_Field is Beta_Types.UInt13;
   ...
   subtype SDRTR_COUNT_Field is Beta_Types.UInt13;
   ...
   subtype SDSR_MODES_Element is Beta_Types.UInt2;
   ...
   type FMC_Peripheral is record
      ...
      --  ECC result register
      ECCR  : aliased Beta_Types.UInt32;
      --  SRAM/NOR-Flash write timing registers 1
