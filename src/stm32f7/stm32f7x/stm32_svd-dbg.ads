...
package STM32_SVD.DBG is
   ...
   subtype DBGMCU_IDCODE_DEV_ID_Field is Beta_Types.UInt12;
   subtype DBGMCU_IDCODE_REV_ID_Field is Beta_Types.UInt16;
   ...
   subtype DBGMCU_CR_TRACE_MODE_Field is Beta_Types.UInt2;
   ...
   type DBGMCU_APB2_FZ_Register is record
      --  TIM1 counter stopped when core is Beta_Typested
      DBG_TIM1_STOP  : Boolean := False;
      --  TIM8 counter stopped when core is Beta_Typested
      DBG_TIM8_STOP  : Boolean := False;
      --  unspecified
      Reserved_2_15  : Beta_Types.UInt14 := 16#0#;
      --  TIM9 counter stopped when core is Beta_Typested
      DBG_TIM9_STOP  : Boolean := False;
      --  TIM10 counter stopped when core is Beta_Typested
      DBG_TIM10_STOP : Boolean := False;
      --  TIM11 counter stopped when core is Beta_Typested
