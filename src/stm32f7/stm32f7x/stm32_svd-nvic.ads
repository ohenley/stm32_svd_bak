...
package STM32_SVD.NVIC is
   ...
   subtype ICTR_INTLINESNUM_Field is Beta_Types.UInt4;
   ...
   subtype IPR_IPR_N_Element is Beta_Types.UInt8;
   ...
   subtype STIR_INTID_Field is Beta_Types.UInt9;
   ...
   type NVIC_Peripheral is record
      ...
      ISER0 : aliased Beta_Types.UInt32;
      --  Interrupt Set-Enable Register
      ISER1 : aliased Beta_Types.UInt32;
      --  Interrupt Set-Enable Register
      ISER2 : aliased Beta_Types.UInt32;
      --  Interrupt Clear-Enable Register
      ICER0 : aliased Beta_Types.UInt32;
      --  Interrupt Clear-Enable Register
      ICER1 : aliased Beta_Types.UInt32;
      --  Interrupt Clear-Enable Register
      ICER2 : aliased Beta_Types.UInt32;
      --  Interrupt Set-Pending Register
      ISPR0 : aliased Beta_Types.UInt32;
      --  Interrupt Set-Pending Register
      ISPR1 : aliased Beta_Types.UInt32;
      --  Interrupt Set-Pending Register
      ISPR2 : aliased Beta_Types.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR0 : aliased Beta_Types.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR1 : aliased Beta_Types.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR2 : aliased Beta_Types.UInt32;
      --  Interrupt Active Bit Register
      IABR0 : aliased Beta_Types.UInt32;
      --  Interrupt Active Bit Register
      IABR1 : aliased Beta_Types.UInt32;
      --  Interrupt Active Bit Register
      IABR2 : aliased Beta_Types.UInt32;
      --  Interrupt Priority Register
