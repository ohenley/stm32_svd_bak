...
package STM32_SVD.FLASH is
   ...
   subtype ACR_LATENCY_Field is Beta_Types.UInt3;
   ...
   subtype CR_SNB_Field is Beta_Types.UInt5;
   subtype CR_PSIZE_Field is Beta_Types.UInt2;
   ...
   type CR_Register is record
      ...
      ERRIE          : Boolean := False;
      --  unspecified
      Reserved_26_30 : Beta_Types.UInt5 := 16#0#;
      --  Lock
      LOCK           : Boolean := True;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype OPTCR_BOR_LEV_Field is Beta_Types.UInt2;
   subtype OPTCR_RDP_Field is Beta_Types.UInt8;
   subtype OPTCR_nWRP_Field is Beta_Types.UInt12;
   ...
   subtype OPTCR1_nWRP_Field is Beta_Types.UInt12;

   --  Flash option control register 1
   type OPTCR1_Register is record
      --  unspecified
      Reserved_0_15  : Beta_Types.UInt16 := 16#0#;
      --  Not write protect
   ...
   type FLASH_Peripheral is record
      ...
      --  Flash key register
      KEYR    : aliased Beta_Types.UInt32;
      --  Flash option key register
      OPTKEYR : aliased Beta_Types.UInt32;
      --  Status register
