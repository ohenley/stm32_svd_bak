...
package STM32_SVD.USB_OTG_FS is
   ...
   subtype OTG_FS_DCFG_DSPD_Field is Beta_Types.UInt2;
   subtype OTG_FS_DCFG_DAD_Field is Beta_Types.UInt7;
   subtype OTG_FS_DCFG_PFIVL_Field is Beta_Types.UInt2;
   ...
   type OTG_FS_DCFG_Register is record
      ...
      --  unspecified
      Reserved_13_31 : Beta_Types.UInt19 := 16#1100#;
   end record
   ...
   subtype OTG_FS_DCTL_TCTL_Field is Beta_Types.UInt3;
   ...
   subtype OTG_FS_DSTS_ENUMSPD_Field is Beta_Types.UInt2;
   subtype OTG_FS_DSTS_FNSOF_Field is Beta_Types.UInt14;
   ...
   type OTG_FS_DIEPMSK_Register is record
      ...
      --  unspecified
      Reserved_7_31 : Beta_Types.UInt25 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_FS_DAINT_IEPINT_Field is Beta_Types.UInt16;
   subtype OTG_FS_DAINT_OEPINT_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_DAINTMSK_IEPM_Field is Beta_Types.UInt16;
   subtype OTG_FS_DAINTMSK_OEPM_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_DVBUSDIS_VBUSDT_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_DVBUSPULSE_DVBUSP_Field is Beta_Types.UInt12;
   ...
   subtype OTG_FS_DIEPEMPMSK_INEPTXFEM_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_DIEPCTL0_MPSIZ_Field is Beta_Types.UInt2;
   subtype OTG_FS_DIEPCTL0_EPTYP_Field is Beta_Types.UInt2;
   subtype OTG_FS_DIEPCTL0_TXFNUM_Field is Beta_Types.UInt4;
   ...
   type OTG_FS_DIEPINT_Register is record
      ...
      TXFE          : Boolean := True;
      --  unspecified
      Reserved_8_31 : Beta_Types.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_FS_DIEPTSIZ0_XFRSIZ_Field is Beta_Types.UInt7;
   subtype OTG_FS_DIEPTSIZ0_PKTCNT_Field is Beta_Types.UInt2;
   ...
   subtype OTG_FS_DTXFSTS_INEPTFSAV_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_DIEPCTL1_MPSIZ_Field is Beta_Types.UInt11;
   subtype OTG_FS_DIEPCTL1_EPTYP_Field is Beta_Types.UInt2;
   subtype OTG_FS_DIEPCTL1_TXFNUM_Field is Beta_Types.UInt4;
   ...
   subtype OTG_FS_DIEPTSIZ_XFRSIZ_Field is Beta_Types.UInt19;
   subtype OTG_FS_DIEPTSIZ_PKTCNT_Field is Beta_Types.UInt10;
   subtype OTG_FS_DIEPTSIZ_MCNT_Field is Beta_Types.UInt2;
   ...
   subtype OTG_FS_DIEPCTL_MPSIZ_Field is Beta_Types.UInt11;
   subtype OTG_FS_DIEPCTL_EPTYP_Field is Beta_Types.UInt2;
   subtype OTG_FS_DIEPCTL_TXFNUM_Field is Beta_Types.UInt4;
   ...
   subtype OTG_FS_DOEPCTL0_MPSIZ_Field is Beta_Types.UInt2;
   subtype OTG_FS_DOEPCTL0_EPTYP_Field is Beta_Types.UInt2;
   ...
   type OTG_FS_DOEPINT_Register is record
      ...
      --  unspecified
      Reserved_7_31 : Beta_Types.UInt25 := 16#1#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_FS_DOEPTSIZ0_XFRSIZ_Field is Beta_Types.UInt7;
   subtype OTG_FS_DOEPTSIZ0_STUPCNT_Field is Beta_Types.UInt2;
   ...
   subtype OTG_FS_DOEPCTL_MPSIZ_Field is Beta_Types.UInt11;
   subtype OTG_FS_DOEPCTL_EPTYP_Field is Beta_Types.UInt2;
   ...
   subtype OTG_FS_DOEPTSIZ_XFRSIZ_Field is Beta_Types.UInt19;
   subtype OTG_FS_DOEPTSIZ_PKTCNT_Field is Beta_Types.UInt10;
   subtype OTG_FS_DOEPTSIZ_RXDPID_STUPCNT_Field is Beta_Types.UInt2;
   ...
   type OTG_FS_GAHBCFG_Register is record
      ...
      GINT          : Boolean := False;
      --  unspecified
      Reserved_1_6  : Beta_Types.UInt6 := 16#0#;
      --  TxFIFO empty level
   ...
   subtype OTG_FS_GUSBCFG_TOCAL_Field is Beta_Types.UInt3;
   subtype OTG_FS_GUSBCFG_TRDT_Field is Beta_Types.UInt4;
   ...
   type OTG_FS_GUSBCFG_Register is record
      ...
      --  unspecified
      Reserved_14_28 : Beta_Types.UInt15 := 16#0#;
      --  Force host mode
      FHMOD          : Boolean := False;
      --  Force device mode
      FDMOD          : Boolean := False;
   ...
   subtype OTG_FS_GRSTCTL_TXFNUM_Field is Beta_Types.UInt5;
   ...
   type OTG_FS_GRSTCTL_Register is record
      ...
      --  unspecified
      Reserved_11_30 : Beta_Types.UInt20 := 16#40000#;
   ...
   type OTG_FS_GINTSTS_Register is record
      ...
      --  unspecified
      Reserved_22_22     : Beta_Types.Bit := 16#0#;
   ...
   subtype OTG_FS_GRXSTSR_Device_EPNUM_Field is Beta_Types.UInt4;
   subtype OTG_FS_GRXSTSR_Device_BCNT_Field is Beta_Types.UInt11;
   subtype OTG_FS_GRXSTSR_Device_DPID_Field is Beta_Types.UInt2;
   subtype OTG_FS_GRXSTSR_Device_PKTSTS_Field is Beta_Types.UInt4;
   subtype OTG_FS_GRXSTSR_Device_FRMNUM_Field is Beta_Types.UInt4;
   ...
   subtype OTG_FS_GRXSTSR_Host_CHNUM_Field is Beta_Types.UInt4;
   subtype OTG_FS_GRXSTSR_Host_BCNT_Field is Beta_Types.UInt11;
   subtype OTG_FS_GRXSTSR_Host_DPID_Field is Beta_Types.UInt2;
   subtype OTG_FS_GRXSTSR_Host_PKTSTS_Field is Beta_Types.UInt4;
   ...
   subtype OTG_FS_GRXSTSP_Device_EPNUM_Field is Beta_Types.UInt4;
   subtype OTG_FS_GRXSTSP_Device_BCNT_Field is Beta_Types.UInt11;
   subtype OTG_FS_GRXSTSP_Device_DPID_Field is Beta_Types.UInt2;
   subtype OTG_FS_GRXSTSP_Device_PKTSTS_Field is Beta_Types.UInt4;
   subtype OTG_FS_GRXSTSP_Device_FRMNUM_Field is Beta_Types.UInt4;
   ...
   subtype OTG_FS_GRXSTSP_Host_CHNUM_Field is Beta_Types.UInt4;
   subtype OTG_FS_GRXSTSP_Host_BCNT_Field is Beta_Types.UInt11;
   subtype OTG_FS_GRXSTSP_Host_DPID_Field is Beta_Types.UInt2;
   subtype OTG_FS_GRXSTSP_Host_PKTSTS_Field is Beta_Types.UInt4;
   ...
   subtype OTG_FS_GRXFSIZ_RXFD_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_DIEPTXF0_Device_TX0FSA_Field is Beta_Types.UInt16;
   subtype OTG_FS_DIEPTXF0_Device_TX0FD_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_HNPTXFSIZ_Host_NPTXFSA_Field is Beta_Types.UInt16;
   subtype OTG_FS_HNPTXFSIZ_Host_NPTXFD_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_HNPTXSTS_NPTXFSAV_Field is Beta_Types.UInt16;
   subtype OTG_FS_HNPTXSTS_NPTQXSAV_Field is Beta_Types.UInt8;
   subtype OTG_FS_HNPTXSTS_NPTXQTOP_Field is Beta_Types.UInt7;
   ...
   subtype OTG_FS_GI2CCTL_RWDATA_Field is Beta_Types.UInt8;
   subtype OTG_FS_GI2CCTL_REGADDR_Field is Beta_Types.UInt8;
   subtype OTG_FS_GI2CCTL_ADDR_Field is Beta_Types.UInt7;
   subtype OTG_FS_GI2CCTL_I2CDEVADR_Field is Beta_Types.UInt2;
   ...
   type OTG_FS_GI2CCTL_Register is record
      ...
      ACK            : Boolean := False;
      --  unspecified
      Reserved_25_25 : Beta_Types.Bit := 16#1#;
      --  I2C Device Address
      I2CDEVADR      : OTG_FS_GI2CCTL_I2CDEVADR_Field := 16#0#;
      --  I2C DatSe0 USB mode
      I2CDATSE0      : Boolean := False;
      --  unspecified
      Reserved_29_29 : Beta_Types.Bit := 16#0#;
   ...
   subtype OTG_FS_GLPMCFG_BESL_Field is Beta_Types.UInt4;
   subtype OTG_FS_GLPMCFG_BESLTHRS_Field is Beta_Types.UInt4;
   subtype OTG_FS_GLPMCFG_LPMRST_Field is Beta_Types.UInt2;
   subtype OTG_FS_GLPMCFG_LPMCHIDX_Field is Beta_Types.UInt4;
   subtype OTG_FS_GLPMCFG_LPMRCNT_Field is Beta_Types.UInt3;
   subtype OTG_FS_GLPMCFG_LPMRCNTSTS_Field is Beta_Types.UInt3;
   ...
   type OTG_FS_GPWRDN_Register is record
      ...
      --  unspecified
      Reserved_1_22  : Beta_Types.UInt22 := 16#200#;
      --  ADP interrupt flag
      ADPIF          : Boolean := False;
      --  unspecified
      Reserved_24_31 : Beta_Types.UInt8 := 16#2#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_FS_GADPCTL_PRBDSCHG_Field is Beta_Types.UInt2;
   subtype OTG_FS_GADPCTL_PRBDELTA_Field is Beta_Types.UInt2;
   subtype OTG_FS_GADPCTL_PRBPER_Field is Beta_Types.UInt2;
   subtype OTG_FS_GADPCTL_RTIM_Field is Beta_Types.UInt11;
   subtype OTG_FS_GADPCTL_AR_Field is Beta_Types.UInt2;
   ...
   subtype OTG_FS_HPTXFSIZ_PTXSA_Field is Beta_Types.UInt16;
   subtype OTG_FS_HPTXFSIZ_PTXFSIZ_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_DIEPTXF_INEPTXSA_Field is Beta_Types.UInt16;
   subtype OTG_FS_DIEPTXF_INEPTXFD_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_HCFG_FSLSPCS_Field is Beta_Types.UInt2;
   ...
   subtype OTG_FS_HFIR_FRIVL_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_HFNUM_FRNUM_Field is Beta_Types.UInt16;
   subtype OTG_FS_HFNUM_FTREM_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_HPTXSTS_PTXFSAVL_Field is Beta_Types.UInt16;
   subtype OTG_FS_HPTXSTS_PTXQSAV_Field is Beta_Types.UInt8;
   subtype OTG_FS_HPTXSTS_PTXQTOP_Field is Beta_Types.UInt8;
   ...
   subtype OTG_FS_HAINT_HAINT_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_HAINTMSK_HAINTM_Field is Beta_Types.UInt16;
   ...
   subtype OTG_FS_HPRT_PLSTS_Field is Beta_Types.UInt2;
   subtype OTG_FS_HPRT_PTCTL_Field is Beta_Types.UInt4;
   subtype OTG_FS_HPRT_PSPD_Field is Beta_Types.UInt2;
   ...
   subtype OTG_FS_HCCHAR_MPSIZ_Field is Beta_Types.UInt11;
   subtype OTG_FS_HCCHAR_EPNUM_Field is Beta_Types.UInt4;
   subtype OTG_FS_HCCHAR_EPTYP_Field is Beta_Types.UInt2;
   subtype OTG_FS_HCCHAR_MCNT_Field is Beta_Types.UInt2;
   subtype OTG_FS_HCCHAR_DAD_Field is Beta_Types.UInt7;
   ...
   subtype OTG_FS_HCTSIZ_XFRSIZ_Field is Beta_Types.UInt19;
   subtype OTG_FS_HCTSIZ_PKTCNT_Field is Beta_Types.UInt10;
   subtype OTG_FS_HCTSIZ_DPID_Field is Beta_Types.UInt2;
   ...
   is record
      ...
      --  core ID register
      OTG_FS_CID             : aliased Beta_Types.UInt32;
      --  OTG core LPM configuration register
