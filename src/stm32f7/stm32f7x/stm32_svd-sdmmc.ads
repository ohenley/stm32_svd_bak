...
package STM32_SVD.SDMMC is
   ...
   subtype CLKCR_CLKDIV_Field is Beta_Types.UInt8;
   ...
   subtype CMD_CMDINDEX_Field is Beta_Types.UInt6;
   ...
   subtype RESPCMD_RESPCMD_Field is Beta_Types.UInt6;
   ...
   subtype DLEN_DATALENGTH_Field is Beta_Types.UInt25;
   ...
   subtype DCOUNT_DATACOUNT_Field is Beta_Types.UInt25;
   ...
   type STA_Register is record
      ...
      RXACT          : Boolean;
      --  Read-only. Transmit FIFO Beta_Typesf empty: at least 8 words can be written
      --  into the FIFO
      TXFIFOHE       : Boolean;
      --  Read-only. Receive FIFO Beta_Typesf full: there are at least 8 words in the
      --  FIFO
      RXFIFOHF       : Boolean;
      ...
      CEATAEND       : Boolean;
      --  unspecified
      Reserved_24_31 : Beta_Types.UInt8;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type ICR_Register is record
      ...
      --  unspecified
      Reserved_11_21 : Beta_Types.UInt11 := 16#0#;
   ...
   type MASK_Register is record
      ...
      --  Tx FIFO Beta_Typesf empty interrupt enable
      TXFIFOHEIE     : Boolean := False;
      --  Rx FIFO Beta_Typesf full interrupt enable
   ...
   subtype FIFOCNT_FIFOCOUNT_Field is Beta_Types.UInt24;
   ...
   type SDMMC_Peripheral is record
      ...
      --  argument register
      ARG     : aliased Beta_Types.UInt32;
      --  command register
      CMD     : aliased CMD_Register;
      --  command response register
      RESPCMD : aliased RESPCMD_Register;
      --  response 1..4 register
      RESP1   : aliased Beta_Types.UInt32;
      --  response 1..4 register
      RESP2   : aliased Beta_Types.UInt32;
      --  response 1..4 register
      RESP3   : aliased Beta_Types.UInt32;
      --  response 1..4 register
      RESP4   : aliased Beta_Types.UInt32;
      --  data timer register
      DTIMER  : aliased Beta_Types.UInt32;
      --  data length register
      ...
      --  data FIFO register
      FIFO    : aliased Beta_Types.UInt32;
   end record
     with Volatile;
