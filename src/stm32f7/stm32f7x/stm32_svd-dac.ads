...
package STM32_SVD.DAC is
   ...
   subtype CR_TSEL1_Field is Beta_Types.UInt3;
   subtype CR_WAVE1_Field is Beta_Types.UInt2;
   subtype CR_MAMP1_Field is Beta_Types.UInt4;
   subtype CR_TSEL2_Field is Beta_Types.UInt3;
   subtype CR_WAVE2_Field is Beta_Types.UInt2;
   subtype CR_MAMP2_Field is Beta_Types.UInt4;
   ...
   subtype DHR12R1_DACC1DHR_Field is Beta_Types.UInt12;
   ...
   subtype DHR12L1_DACC1DHR_Field is Beta_Types.UInt12;
   ...
   subtype DHR8R1_DACC1DHR_Field is Beta_Types.UInt8;
   ...
   subtype DHR12R2_DACC2DHR_Field is Beta_Types.UInt12;
   ...
   subtype DHR12L2_DACC2DHR_Field is Beta_Types.UInt12;
   ...
   subtype DHR8R2_DACC2DHR_Field is Beta_Types.UInt8;
   ...
   subtype DHR12RD_DACC1DHR_Field is Beta_Types.UInt12;
   subtype DHR12RD_DACC2DHR_Field is Beta_Types.UInt12;
   ...
   subtype DHR12LD_DACC1DHR_Field is Beta_Types.UInt12;
   subtype DHR12LD_DACC2DHR_Field is Beta_Types.UInt12;
   ...
   type DHR12LD_Register is record
      ...
      --  unspecified
      Reserved_16_19 : Beta_Types.UInt4 := 16#0#;
      --  DAC channel2 12-bit left-aligned data
   ...
   subtype DHR8RD_DACC1DHR_Field is Beta_Types.UInt8;
   subtype DHR8RD_DACC2DHR_Field is Beta_Types.UInt8;
   ...
   subtype DOR1_DACC1DOR_Field is Beta_Types.UInt12;
   ...
   type DOR1_Register is record
      ...
      --  unspecified
      Reserved_12_31 : Beta_Types.UInt20;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DOR2_DACC2DOR_Field is Beta_Types.UInt12;
   ...
   type SR_Register is record
      --  unspecified
      Reserved_0_12  : Beta_Types.UInt13 := 16#0#;
