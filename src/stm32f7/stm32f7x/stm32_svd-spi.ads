...
package STM32_SVD.SPI is
   ...
   subtype CR1_BR_Field is Beta_Types.UInt3;
   ...
   type CR2_Register is record
      ...
      --  FIFO reception threshold
      FRXTH          : CR2_FRXTH_Field := STM32_SVD.SPI.Beta_Typesf;
      --  Last DMA transfer for reception
   ...
   subtype DR_DR_Field is Beta_Types.UInt16;
   ...
   subtype CRCPR_CRCPOLY_Field is Beta_Types.UInt16;
   ...
   subtype RXCRCR_RxCRC_Field is Beta_Types.UInt16;
   ...
   subtype TXCRCR_TxCRC_Field is Beta_Types.UInt16;
   ...
   subtype I2SCFGR_DATLEN_Field is Beta_Types.UInt2;
   subtype I2SCFGR_I2SSTD_Field is Beta_Types.UInt2;
   subtype I2SCFGR_I2SCFG_Field is Beta_Types.UInt2;
   ...
   subtype I2SPR_I2SDIV_Field is Beta_Types.UInt8;
