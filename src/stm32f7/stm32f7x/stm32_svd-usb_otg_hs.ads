...
package STM32_SVD.USB_OTG_HS is
   ...
   subtype OTG_HS_DCFG_DSPD_Field is Beta_Types.UInt2;
   subtype OTG_HS_DCFG_DAD_Field is Beta_Types.UInt7;
   subtype OTG_HS_DCFG_PFIVL_Field is Beta_Types.UInt2;
   subtype OTG_HS_DCFG_PERSCHIVL_Field is Beta_Types.UInt2;
   ...
   subtype OTG_HS_DCTL_TCTL_Field is Beta_Types.UInt3;
   ...
   type OTG_HS_DCTL_Register is record
      ...
      --  unspecified
      Reserved_12_31 : Beta_Types.UInt20 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DSTS_ENUMSPD_Field is Beta_Types.UInt2;
   subtype OTG_HS_DSTS_FNSOF_Field is Beta_Types.UInt14;
   ...
   type OTG_HS_DIEPMSK_Register is record
      ...
      EPDM           : Boolean := False;
      --  unspecified
      Reserved_2_2   : Beta_Types.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_7_7   : Beta_Types.Bit := 16#0#;
      --  FIFO underrun mask
      TXFURM         : Boolean := False;
      --  BNA interrupt mask
      BIM            : Boolean := False;
      --  unspecified
      Reserved_10_31 : Beta_Types.UInt22 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type OTG_HS_DOEPMSK_Register is record
      ...
      --  unspecified
      Reserved_5_5   : Beta_Types.Bit := 16#0#;
   ...
   subtype OTG_HS_DAINT_IEPINT_Field is Beta_Types.UInt16;
   subtype OTG_HS_DAINT_OEPINT_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_DAINTMSK_IEPM_Field is Beta_Types.UInt16;
   subtype OTG_HS_DAINTMSK_OEPM_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_DVBUSDIS_VBUSDT_Field is Beta_Types.UInt16;
   ...
   type OTG_HS_DVBUSDIS_Register is record
      ...
      --  unspecified
      Reserved_16_31 : Beta_Types.UInt16 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DVBUSPULSE_DVBUSP_Field is Beta_Types.UInt12;
   ...
   subtype OTG_HS_DTHRCTL_TXTHRLEN_Field is Beta_Types.UInt9;
   subtype OTG_HS_DTHRCTL_RXTHRLEN_Field is Beta_Types.UInt9;
   ...
   type OTG_HS_DTHRCTL_Register is record
      ...
      --  unspecified
      Reserved_11_15 : Beta_Types.UInt5 := 16#0#;
      --  Receive threshold enable
      RXTHREN        : Boolean := False;
      --  Receive threshold length
      RXTHRLEN       : OTG_HS_DTHRCTL_RXTHRLEN_Field := 16#0#;
      --  unspecified
      Reserved_26_26 : Beta_Types.Bit := 16#0#;
      --  Arbiter parking enable
      ARPEN          : Boolean := False;
      --  unspecified
      Reserved_28_31 : Beta_Types.UInt4 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DIEPEMPMSK_INEPTXFEM_Field is Beta_Types.UInt16;
   ...
   type OTG_HS_DEACHINT_Register is record
      --  unspecified
      Reserved_0_0   : Beta_Types.Bit := 16#0#;
      --  IN endpoint 1interrupt bit
      IEP1INT        : Boolean := False;
      --  unspecified
      Reserved_2_16  : Beta_Types.UInt15 := 16#0#;
      --  OUT endpoint 1 interrupt bit
      OEP1INT        : Boolean := False;
      --  unspecified
      Reserved_18_31 : Beta_Types.UInt14 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DIEPCTL_MPSIZ_Field is Beta_Types.UInt11;
   subtype OTG_HS_DIEPCTL_EPTYP_Field is Beta_Types.UInt2;
   subtype OTG_HS_DIEPCTL_TXFNUM_Field is Beta_Types.UInt4;
   ...
   type OTG_HS_DIEPCTL_Register is record
      ...
      --  unspecified
      Reserved_11_14 : Beta_Types.UInt4 := 16#0#;
      --  USB active endpoint
      ...
      --  unspecified
      Reserved_20_20 : Beta_Types.Bit := 16#0#;
      --  STALL handshake
      Stall          : Boolean := False;
      --  TxFIFO number
   ...
   type OTG_HS_DIEPINT_Register is record
      ...
      BNA            : Boolean := False;
      --  unspecified
      Reserved_10_10 : Beta_Types.Bit := 16#0#;
      ...
      NAK            : Boolean := False;
      --  unspecified
      Reserved_14_31 : Beta_Types.UInt18 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DIEPTSIZ0_XFRSIZ_Field is Beta_Types.UInt7;
   subtype OTG_HS_DIEPTSIZ0_PKTCNT_Field is Beta_Types.UInt2;
   ...
   type OTG_HS_DIEPTSIZ0_Register is record
      ...
      --  unspecified
      Reserved_7_18  : Beta_Types.UInt12 := 16#0#;
      --  Packet count
      PKTCNT         : OTG_HS_DIEPTSIZ0_PKTCNT_Field := 16#0#;
      --  unspecified
      Reserved_21_31 : Beta_Types.UInt11 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DTXFSTS_INEPTFSAV_Field is Beta_Types.UInt16;
   ...
   type OTG_HS_DTXFSTS_Register is record
      ...
      --  unspecified
      Reserved_16_31 : Beta_Types.UInt16;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DIEPTSIZ_XFRSIZ_Field is Beta_Types.UInt19;
   subtype OTG_HS_DIEPTSIZ_PKTCNT_Field is Beta_Types.UInt10;
   subtype OTG_HS_DIEPTSIZ_MCNT_Field is Beta_Types.UInt2;
   ...
   type OTG_HS_DIEPTSIZ_Register is record
      ...
      --  unspecified
      Reserved_31_31 : Beta_Types.Bit := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DOEPCTL0_MPSIZ_Field is Beta_Types.UInt2;
   subtype OTG_HS_DOEPCTL0_EPTYP_Field is Beta_Types.UInt2;
   ...
   type OTG_HS_DOEPCTL0_Register is record
      ...
      --  unspecified
      Reserved_2_14  : Beta_Types.UInt13 := 16#0#;
      --  Read-only. USB active endpoint
      USBAEP         : Boolean := True;
      --  unspecified
      Reserved_16_16 : Beta_Types.Bit := 16#0#;
      --  Read-only. NAK status
      NAKSTS         : Boolean := False;
      ...
      Stall          : Boolean := False;
      --  unspecified
      Reserved_22_25 : Beta_Types.UInt4 := 16#0#;
      --  Write-only. Clear NAK
      CNAK           : Boolean := False;
      --  Write-only. Set NAK
      SNAK           : Boolean := False;
      --  unspecified
      Reserved_28_29 : Beta_Types.UInt2 := 16#0#;
   ...
   type OTG_HS_DOEPINT_Register is record
      ...
      B2BSTUP        : Boolean := False;
      --  unspecified
      Reserved_7_13  : Beta_Types.UInt7 := 16#1#;
      --  NYET interrupt
      NYET           : Boolean := False;
      --  unspecified
      Reserved_15_31 : Beta_Types.UInt17 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DOEPTSIZ0_XFRSIZ_Field is Beta_Types.UInt7;
   subtype OTG_HS_DOEPTSIZ0_STUPCNT_Field is Beta_Types.UInt2;
   ...
   type OTG_HS_DOEPTSIZ0_Register is record
      ...
      --  unspecified
      Reserved_20_28 : Beta_Types.UInt9 := 16#0#;
      --  SETUP packet count
   ...
   subtype OTG_HS_DOEPCTL_MPSIZ_Field is Beta_Types.UInt11;
   subtype OTG_HS_DOEPCTL_EPTYP_Field is Beta_Types.UInt2;
   ...
   subtype OTG_HS_DOEPTSIZ_XFRSIZ_Field is Beta_Types.UInt19;
   subtype OTG_HS_DOEPTSIZ_PKTCNT_Field is Beta_Types.UInt10;
   subtype OTG_HS_DOEPTSIZ_RXDPID_STUPCNT_Field is Beta_Types.UInt2;
   ...
   type OTG_HS_GOTGCTL_Register is record
      ...
      SRQ            : Boolean := False;
      --  unspecified
      Reserved_2_7   : Beta_Types.UInt6 := 16#0#;
      ...
      EHEN           : Boolean := False;
      --  unspecified
      Reserved_13_15 : Beta_Types.UInt3 := 16#0#;
      ...
      BSVLD          : Boolean := False;
      --  unspecified
      Reserved_20_31 : Beta_Types.UInt12 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type OTG_HS_GOTGINT_Register is record
      --  unspecified
      Reserved_0_1   : Beta_Types.UInt2 := 16#0#;
      --  Session end detected
      SEDET          : Boolean := False;
      --  unspecified
      Reserved_3_7   : Beta_Types.UInt5 := 16#0#;
      --  Session request success status change
      SRSSCHG        : Boolean := False;
      --  Host negotiation success status change
      HNSSCHG        : Boolean := False;
      --  unspecified
      Reserved_10_16 : Beta_Types.UInt7 := 16#0#;
   ...
   subtype OTG_HS_GAHBCFG_HBSTLEN_Field is Beta_Types.UInt4;
   ...
   type OTG_HS_GAHBCFG_Register is record
      ...
      DMAEN         : Boolean := False;
      --  unspecified
      Reserved_6_6  : Beta_Types.Bit := 16#0#;
      --  TxFIFO empty level
      TXFELVL       : Boolean := False;
      --  Periodic TxFIFO empty level
      PTXFELVL      : Boolean := False;
      --  unspecified
      Reserved_9_31 : Beta_Types.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_GUSBCFG_TOCAL_Field is Beta_Types.UInt3;
   subtype OTG_HS_GUSBCFG_TRDT_Field is Beta_Types.UInt4;
   ...
   type OTG_HS_GUSBCFG_Register is record
      ...
      --  unspecified
      Reserved_3_5   : Beta_Types.UInt3 := 16#0#;
      ...
      --  unspecified
      Reserved_14_14 : Beta_Types.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_26_28 : Beta_Types.UInt3 := 16#0#;
      --  Forced host mode
      FHMOD          : Boolean := False;
   ...
   subtype OTG_HS_GRSTCTL_TXFNUM_Field is Beta_Types.UInt5;
   ...
   type OTG_HS_GRSTCTL_Register is record
      ...
      --  unspecified
      Reserved_11_29 : Beta_Types.UInt19 := 16#40000#;
   ...
   type OTG_HS_GINTSTS_Register is record
      ...
      --  unspecified
      Reserved_8_9      : Beta_Types.UInt2 := 16#0#;
      --  Early suspend
      ESUSP             : Boolean := False;
      --  USB suspend
      ...
      EOPF              : Boolean := False;
      --  unspecified
      Reserved_16_17    : Beta_Types.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_23_23    : Beta_Types.Bit := 16#0#;
      ...
      PTXFE             : Boolean := True;
      --  unspecified
      Reserved_27_27    : Beta_Types.Bit := 16#0#;
   ...
   subtype OTG_HS_GRXSTSR_Host_CHNUM_Field is Beta_Types.UInt4;
   subtype OTG_HS_GRXSTSR_Host_BCNT_Field is Beta_Types.UInt11;
   subtype OTG_HS_GRXSTSR_Host_DPID_Field is Beta_Types.UInt2;
   subtype OTG_HS_GRXSTSR_Host_PKTSTS_Field is Beta_Types.UInt4;
   ...
   type OTG_HS_GRXSTSR_Host_Register is record
      ...
      --  unspecified
      Reserved_21_31 : Beta_Types.UInt11;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_GRXSTSR_Device_EPNUM_Field is Beta_Types.UInt4;
   subtype OTG_HS_GRXSTSR_Device_BCNT_Field is Beta_Types.UInt11;
   subtype OTG_HS_GRXSTSR_Device_DPID_Field is Beta_Types.UInt2;
   subtype OTG_HS_GRXSTSR_Device_PKTSTS_Field is Beta_Types.UInt4;
   subtype OTG_HS_GRXSTSR_Device_FRMNUM_Field is Beta_Types.UInt4;
   ...
   type OTG_HS_GRXSTSR_Device_Register is record
      ...
      --  unspecified
      Reserved_25_31 : Beta_Types.UInt7;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_GRXSTSP_Host_CHNUM_Field is Beta_Types.UInt4;
   subtype OTG_HS_GRXSTSP_Host_BCNT_Field is Beta_Types.UInt11;
   subtype OTG_HS_GRXSTSP_Host_DPID_Field is Beta_Types.UInt2;
   subtype OTG_HS_GRXSTSP_Host_PKTSTS_Field is Beta_Types.UInt4;
   ...
   subtype OTG_HS_GRXSTSP_Device_EPNUM_Field is Beta_Types.UInt4;
   subtype OTG_HS_GRXSTSP_Device_BCNT_Field is Beta_Types.UInt11;
   subtype OTG_HS_GRXSTSP_Device_DPID_Field is Beta_Types.UInt2;
   subtype OTG_HS_GRXSTSP_Device_PKTSTS_Field is Beta_Types.UInt4;
   subtype OTG_HS_GRXSTSP_Device_FRMNUM_Field is Beta_Types.UInt4;
   ...
   subtype OTG_HS_GRXFSIZ_RXFD_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_HNPTXFSIZ_Host_NPTXFSA_Field is Beta_Types.UInt16;
   subtype OTG_HS_HNPTXFSIZ_Host_NPTXFD_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_DIEPTXF0_Device_TX0FSA_Field is Beta_Types.UInt16;
   subtype OTG_HS_DIEPTXF0_Device_TX0FD_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_GNPTXSTS_NPTXFSAV_Field is Beta_Types.UInt16;
   subtype OTG_HS_GNPTXSTS_NPTQXSAV_Field is Beta_Types.UInt8;
   subtype OTG_HS_GNPTXSTS_NPTXQTOP_Field is Beta_Types.UInt7;
   ...
   type OTG_HS_GCCFG_Register is record
      ...
      --  unspecified
      Reserved_4_15  : Beta_Types.UInt12 := 16#0#;
      --  Power down
      ...
      VBDEN          : Boolean := False;
      --  unspecified
      Reserved_22_31 : Beta_Types.UInt10 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_GLPMCFG_BESL_Field is Beta_Types.UInt4;
   subtype OTG_HS_GLPMCFG_BESLTHRS_Field is Beta_Types.UInt4;
   subtype OTG_HS_GLPMCFG_LPMRST_Field is Beta_Types.UInt2;
   subtype OTG_HS_GLPMCFG_LPMCHIDX_Field is Beta_Types.UInt4;
   subtype OTG_HS_GLPMCFG_LPMRCNT_Field is Beta_Types.UInt3;
   subtype OTG_HS_GLPMCFG_LPMRCNTSTS_Field is Beta_Types.UInt3;
   ...
   type OTG_HS_GLPMCFG_Register is record
      ...
      --  L1 SBeta_Typeslow Sleep enable
      ...
      --  unspecified
      Reserved_29_31 : Beta_Types.UInt3 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_HPTXFSIZ_PTXSA_Field is Beta_Types.UInt16;
   subtype OTG_HS_HPTXFSIZ_PTXFD_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_DIEPTXF_INEPTXSA_Field is Beta_Types.UInt16;
   subtype OTG_HS_DIEPTXF_INEPTXFD_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_HCFG_FSLSPCS_Field is Beta_Types.UInt2;
   ...
   type OTG_HS_HCFG_Register is record
      ...
      FSLSS         : Boolean := False;
      --  unspecified
      Reserved_3_31 : Beta_Types.UInt29 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_HFIR_FRIVL_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_HFNUM_FRNUM_Field is Beta_Types.UInt16;
   subtype OTG_HS_HFNUM_FTREM_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_HPTXSTS_PTXFSAVL_Field is Beta_Types.UInt16;
   subtype OTG_HS_HPTXSTS_PTXQSAV_Field is Beta_Types.UInt8;
   subtype OTG_HS_HPTXSTS_PTXQTOP_Field is Beta_Types.UInt8;
   ...
   subtype OTG_HS_HAINT_HAINT_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_HAINTMSK_HAINTM_Field is Beta_Types.UInt16;
   ...
   subtype OTG_HS_HPRT_PLSTS_Field is Beta_Types.UInt2;
   subtype OTG_HS_HPRT_PTCTL_Field is Beta_Types.UInt4;
   subtype OTG_HS_HPRT_PSPD_Field is Beta_Types.UInt2;
   ...
   type OTG_HS_HPRT_Register is record
      ...
      PRST           : Boolean := False;
      --  unspecified
      Reserved_9_9   : Beta_Types.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_19_31 : Beta_Types.UInt13 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_HCCHAR_MPSIZ_Field is Beta_Types.UInt11;
   subtype OTG_HS_HCCHAR_EPNUM_Field is Beta_Types.UInt4;
   subtype OTG_HS_HCCHAR_EPTYP_Field is Beta_Types.UInt2;
   subtype OTG_HS_HCCHAR_MC_Field is Beta_Types.UInt2;
   subtype OTG_HS_HCCHAR_DAD_Field is Beta_Types.UInt7;
   ...
   subtype OTG_HS_HCSPLT_PRTADDR_Field is Beta_Types.UInt7;
   subtype OTG_HS_HCSPLT_HUBADDR_Field is Beta_Types.UInt7;
   subtype OTG_HS_HCSPLT_XACTPOS_Field is Beta_Types.UInt2;
   ...
   type OTG_HS_HCSPLT_Register is record
      ...
      --  unspecified
      Reserved_17_30 : Beta_Types.UInt14 := 16#0#;
      --  Split enable
   ...
   type OTG_HS_HCINT_Register is record
      ...
      DTERR          : Boolean := False;
      --  unspecified
      Reserved_11_31 : Beta_Types.UInt21 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_HCTSIZ_XFRSIZ_Field is Beta_Types.UInt19;
   subtype OTG_HS_HCTSIZ_PKTCNT_Field is Beta_Types.UInt10;
   subtype OTG_HS_HCTSIZ_DPID_Field is Beta_Types.UInt2;
   ...
   type OTG_HS_PCGCR_Register is record
      ...
      --  unspecified
      Reserved_2_3  : Beta_Types.UInt2 := 16#0#;
      --  PHY suspended
      PHYSUSP       : Boolean := False;
      --  unspecified
      Reserved_5_31 : Beta_Types.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type OTG_HS_DEVICE_Peripheral is record
      ...
      OTG_HS_DIEPDMA1    : aliased Beta_Types.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA2    : aliased Beta_Types.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA3    : aliased Beta_Types.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA4    : aliased Beta_Types.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA5    : aliased Beta_Types.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
   ...
   is record
      ...
      OTG_HS_CID             : aliased Beta_Types.UInt32;
      --  OTG core LPM configuration register
   ...
   type OTG_HS_HOST_Peripheral is record
      ...
      OTG_HS_HCDMA0     : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA1     : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA2     : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA3     : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA4     : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA5     : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA6     : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA7     : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA8     : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA9     : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA10    : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA11    : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA12    : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA13    : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA14    : aliased Beta_Types.UInt32;
      ...
      OTG_HS_HCDMA15    : aliased Beta_Types.UInt32;
   end record
     with Volatile;
