...
package STM32_SVD.SPDIF_RX is
   ...
   subtype CR_SPDIFEN_Field is Beta_Types.UInt2;
   subtype CR_DRFMT_Field is Beta_Types.UInt2;
   subtype CR_NBTR_Field is Beta_Types.UInt2;
   subtype CR_INSEL_Field is Beta_Types.UInt3;
   ...
   subtype SR_WIDTH5_Field is Beta_Types.UInt15;
   ...
   type SR_Register is record
      ...
      TERR           : Boolean;
      --  unspecified
      Reserved_9_15  : Beta_Types.UInt7;
   ...
   subtype DR_DR_Field is Beta_Types.UInt24;
   subtype DR_PT_Field is Beta_Types.UInt2;
   ...
   type DR_Register is record
      ...
      PT             : DR_PT_Field;
      --  unspecified
      Reserved_30_31 : Beta_Types.UInt2;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CSR_USR_Field is Beta_Types.UInt16;
   subtype CSR_CS_Field is Beta_Types.UInt8;
   ...
   subtype DIR_THI_Field is Beta_Types.UInt13;
   subtype DIR_TLO_Field is Beta_Types.UInt13;
   ...
   type DIR_Register is record
      ...
      THI            : DIR_THI_Field;
      --  unspecified
      Reserved_13_15 : Beta_Types.UInt3;
      --  Read-only. Threshold LOW
      TLO            : DIR_TLO_Field;
      --  unspecified
      Reserved_29_31 : Beta_Types.UInt3;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
