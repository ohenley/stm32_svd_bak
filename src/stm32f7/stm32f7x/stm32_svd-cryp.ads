...
package STM32_SVD.CRYP is
   ...
   subtype CR_ALGOMODE0_Field is Beta_Types.UInt3;
   subtype CR_DATATYPE_Field is Beta_Types.UInt2;
   subtype CR_KEYSIZE_Field is Beta_Types.UInt2;
   subtype CR_GCM_CCMPH_Field is Beta_Types.UInt2;
   ...
   type CR_Register is record
      ...
      --  unspecified
      Reserved_10_13 : Beta_Types.UInt4 := 16#0#;
   ...
   type SR_Register is record
      ...
      BUSY          : Boolean;
      --  unspecified
      Reserved_5_31 : Beta_Types.UInt27;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type CRYP_Peripheral is record
      ...
      DOUT       : aliased Beta_Types.UInt32;
      --  DMA control register
      ...
      CSGCMCCM0R : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCMCCM1R : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCMCCM2R : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCMCCM3R : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCMCCM4R : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCMCCM5R : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCMCCM6R : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCMCCM7R : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCM0R    : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCM1R    : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCM2R    : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCM3R    : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCM4R    : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCM5R    : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCM6R    : aliased Beta_Types.UInt32;
      --  context swap register
      CSGCM7R    : aliased Beta_Types.UInt32;
   end record
     with Volatile;
