...
package STM32_SVD.LPTIM is
   ...
   type ISR_Register is record
      ...
      DOWN          : Boolean;
      --  unspecified
      Reserved_7_31 : Beta_Types.UInt25;
   end record
   ...
   subtype CFGR_CKPOL_Field is Beta_Types.UInt2;
   subtype CFGR_CKFLT_Field is Beta_Types.UInt2;
   subtype CFGR_TRGFLT_Field is Beta_Types.UInt2;
   subtype CFGR_PRESC_Field is Beta_Types.UInt3;
   subtype CFGR_TRIGSEL_Field is Beta_Types.UInt3;
   subtype CFGR_TRIGEN_Field is Beta_Types.UInt2;
   ...
   subtype CMP_CMP_Field is Beta_Types.UInt16;
