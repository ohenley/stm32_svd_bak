...
package STM32_SVD.USART is
   ...
   subtype CR2_STOP_Field is Beta_Types.UInt2;
   ...
   subtype CR2_ADD0_3_Field is Beta_Types.UInt4;
   subtype CR2_ADD4_7_Field is Beta_Types.UInt4;
   ...
   subtype CR3_SCARCNT_Field is Beta_Types.UInt3;
   subtype CR3_WUS_Field is Beta_Types.UInt2;
   ...
   subtype BRR_DIV_Fraction_Field is Beta_Types.UInt4;
   subtype BRR_DIV_Mantissa_Field is Beta_Types.UInt12;
   ...
   subtype GTPR_PSC_Field is Beta_Types.UInt8;
   subtype GTPR_GT_Field is Beta_Types.UInt8;
   ...
   subtype RTOR_RTO_Field is Beta_Types.UInt24;
   subtype RTOR_BLEN_Field is Beta_Types.UInt8;
   ...
   type ICR_Register is record
      ...
      EOBCF          : Boolean := False;
      --  unspecified
      Reserved_13_16 : Beta_Types.UInt4 := 16#0#;
   ...
   subtype RDR_RDR_Field is Beta_Types.UInt9;
   ...
   type RDR_Register is record
      ...
      RDR           : RDR_RDR_Field;
      --  unspecified
      Reserved_9_31 : Beta_Types.UInt23;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype TDR_TDR_Field is Beta_Types.UInt9;
