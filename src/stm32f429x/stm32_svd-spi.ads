...
package STM32_SVD.SPI is
   ...
   subtype CR1_BR_Field is BT.UInt3;
   ...
   subtype DR_DR_Field is BT.UInt16;
   ...
   subtype CRCPR_CRCPOLY_Field is BT.UInt16;
   ...
   subtype RXCRCR_RxCRC_Field is BT.UInt16;
   ...
   subtype TXCRCR_TxCRC_Field is BT.UInt16;
   ...
   subtype I2SCFGR_DATLEN_Field is BT.UInt2;
   subtype I2SCFGR_I2SSTD_Field is BT.UInt2;
   subtype I2SCFGR_I2SCFG_Field is BT.UInt2;
   ...
   subtype I2SPR_I2SDIV_Field is BT.UInt8;
