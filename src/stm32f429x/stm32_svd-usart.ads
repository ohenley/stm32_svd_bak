...
package STM32_SVD.USART is
   ...
   type SR_Register is record
      ...
      LBD           : Boolean := False;
      --  unspecified
      Reserved_9_31 : BT.UInt23 := 16#6000#;
   end record
   ...
   subtype DR_DR_Field is BT.UInt9;
   ...
   subtype BRR_DIV_Fraction_Field is BT.UInt4;
   subtype BRR_DIV_Mantissa_Field is BT.UInt12;
   ...
   subtype CR2_ADD_Field is BT.UInt4;
   subtype CR2_STOP_Field is BT.UInt2;
   ...
   type CR3_Register is record
      ...
      HDSEL          : Boolean := False;
      --  unspecified
      Reserved_4_5   : BT.UInt2 := 16#0#;
      --  DMA enable receiver
      DMAR           : Boolean := False;
      --  DMA enable transmitter
      DMAT           : Boolean := False;
      --  unspecified
      Reserved_8_10  : BT.UInt3 := 16#0#;
   ...
   type SR_Register_1 is record
      ...
      CTS            : Boolean := False;
      --  unspecified
      Reserved_10_31 : BT.UInt22 := 16#3000#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype GTPR_PSC_Field is BT.UInt8;
   subtype GTPR_GT_Field is BT.UInt8;
