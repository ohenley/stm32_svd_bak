...
package STM32_SVD.ADC is
   ...
   subtype CR1_AWDCH_Field is BT.UInt5;
   subtype CR1_DISCNUM_Field is BT.UInt3;
   subtype CR1_RES_Field is BT.UInt2;
   ...
   subtype CR2_JEXTSEL_Field is BT.UInt4;
   subtype CR2_JEXTEN_Field is BT.UInt2;
   subtype CR2_EXTSEL_Field is BT.UInt4;
   subtype CR2_EXTEN_Field is BT.UInt2;
   ...
   subtype SMPR1_SMP_Element is BT.UInt3;
   ...
   subtype SMPR2_SMP_Element is BT.UInt3;
   ...
   subtype JOFR1_JOFFSET1_Field is BT.UInt12;
   ...
   subtype JOFR2_JOFFSET2_Field is BT.UInt12;
   ...
   subtype JOFR3_JOFFSET3_Field is BT.UInt12;
   ...
   subtype JOFR4_JOFFSET4_Field is BT.UInt12;
   ...
   subtype HTR_HT_Field is BT.UInt12;
   ...
   subtype LTR_LT_Field is BT.UInt12;
   ...
   subtype SQR1_SQ_Element is BT.UInt5;
   ...
   subtype SQR1_L_Field is BT.UInt4;
   ...
   subtype SQR2_SQ_Element is BT.UInt5;
   ...
   subtype SQR3_SQ_Element is BT.UInt5;
   ...
   subtype JSQR_JSQ_Element is BT.UInt5;
   ...
   subtype JSQR_JL_Field is BT.UInt2;
   ...
   subtype JDR_JDATA_Field is BT.UInt16;
   ...
   subtype DR_DATA_Field is BT.UInt16;
   ...
   subtype CCR_MULT_Field is BT.UInt5;
   subtype CCR_DELAY_Field is BT.UInt4;
   subtype CCR_DMA_Field is BT.UInt2;
   subtype CCR_ADCPRE_Field is BT.UInt2;
   ...
   subtype CDR_DATA_Element is BT.UInt16;
