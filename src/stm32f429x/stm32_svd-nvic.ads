...
package STM32_SVD.NVIC is
   ...
   subtype ICTR_INTLINESNUM_Field is BT.UInt4;
   ...
   subtype IPR_IPR_N_Element is BT.UInt8;
   ...
   subtype STIR_INTID_Field is BT.UInt9;
   ...
   type NVIC_Peripheral is record
      ...
      ISER0 : aliased BT.UInt32;
      --  Interrupt Set-Enable Register
      ISER1 : aliased BT.UInt32;
      --  Interrupt Set-Enable Register
      ISER2 : aliased BT.UInt32;
      --  Interrupt Clear-Enable Register
      ICER0 : aliased BT.UInt32;
      --  Interrupt Clear-Enable Register
      ICER1 : aliased BT.UInt32;
      --  Interrupt Clear-Enable Register
      ICER2 : aliased BT.UInt32;
      --  Interrupt Set-Pending Register
      ISPR0 : aliased BT.UInt32;
      --  Interrupt Set-Pending Register
      ISPR1 : aliased BT.UInt32;
      --  Interrupt Set-Pending Register
      ISPR2 : aliased BT.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR0 : aliased BT.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR1 : aliased BT.UInt32;
      --  Interrupt Clear-Pending Register
      ICPR2 : aliased BT.UInt32;
      --  Interrupt Active Bit Register
      IABR0 : aliased BT.UInt32;
      --  Interrupt Active Bit Register
      IABR1 : aliased BT.UInt32;
      --  Interrupt Active Bit Register
      IABR2 : aliased BT.UInt32;
      --  Interrupt Priority Register
