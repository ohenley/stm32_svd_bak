...
package STM32_SVD.DCMI is
   ...
   subtype CR_FCRC_Field is BT.UInt2;
   subtype CR_EDM_Field is BT.UInt2;
   ...
   subtype ESCR_FSC_Field is BT.UInt8;
   subtype ESCR_LSC_Field is BT.UInt8;
   subtype ESCR_LEC_Field is BT.UInt8;
   subtype ESCR_FEC_Field is BT.UInt8;
   ...
   subtype ESUR_FSU_Field is BT.UInt8;
   subtype ESUR_LSU_Field is BT.UInt8;
   subtype ESUR_LEU_Field is BT.UInt8;
   subtype ESUR_FEU_Field is BT.UInt8;
   ...
   subtype CWSTRT_HOFFCNT_Field is BT.UInt14;
   subtype CWSTRT_VST_Field is BT.UInt13;
   ...
   subtype CWSIZE_CAPCNT_Field is BT.UInt14;
   subtype CWSIZE_VLINE_Field is BT.UInt14;
   ...
   subtype DR_Byte_Element is BT.UInt8;
