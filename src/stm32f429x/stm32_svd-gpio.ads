...
package STM32_SVD.GPIO is
   ...
   --  MODER array element
   subtype MODER_Element is BT.UInt2;
   ...
   subtype OSPEEDR_Element is BT.UInt2;
   ...
   --  PUPDR array element
   subtype PUPDR_Element is BT.UInt2;
   ...
   --  AFRL array element
   subtype AFRL_Element is BT.UInt4;
   ...
   --  AFRH array element
   subtype AFRH_Element is BT.UInt4;
