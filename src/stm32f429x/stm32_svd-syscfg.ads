...
package STM32_SVD.SYSCFG is
   ...
   subtype MEMRM_MEM_MODE_Field is BT.UInt3;
   subtype MEMRM_SWP_FMC_Field is BT.UInt2;
   ...
   subtype EXTICR1_EXTI_Element is BT.UInt4;
   ...
   subtype EXTICR2_EXTI_Element is BT.UInt4;
   ...
   subtype EXTICR3_EXTI_Element is BT.UInt4;
   ...
   subtype EXTICR4_EXTI_Element is BT.UInt4;
