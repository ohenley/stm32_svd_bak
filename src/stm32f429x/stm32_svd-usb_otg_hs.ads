...
package STM32_SVD.USB_OTG_HS is
   ...
   subtype OTG_HS_DCFG_DSPD_Field is BT.UInt2;
   subtype OTG_HS_DCFG_DAD_Field is BT.UInt7;
   subtype OTG_HS_DCFG_PFIVL_Field is BT.UInt2;
   subtype OTG_HS_DCFG_PERSCHIVL_Field is BT.UInt2;
   ...
   subtype OTG_HS_DCTL_TCTL_Field is BT.UInt3;
   ...
   subtype OTG_HS_DSTS_ENUMSPD_Field is BT.UInt2;
   subtype OTG_HS_DSTS_FNSOF_Field is BT.UInt14;
   ...
   subtype OTG_HS_DAINT_IEPINT_Field is BT.UInt16;
   subtype OTG_HS_DAINT_OEPINT_Field is BT.UInt16;
   ...
   subtype OTG_HS_DAINTMSK_IEPM_Field is BT.UInt16;
   subtype OTG_HS_DAINTMSK_OEPM_Field is BT.UInt16;
   ...
   subtype OTG_HS_DVBUSDIS_VBUSDT_Field is BT.UInt16;
   ...
   subtype OTG_HS_DVBUSPULSE_DVBUSP_Field is BT.UInt12;
   ...
   subtype OTG_HS_DTHRCTL_TXTHRLEN_Field is BT.UInt9;
   subtype OTG_HS_DTHRCTL_RXTHRLEN_Field is BT.UInt9;
   ...
   subtype OTG_HS_DIEPEMPMSK_INEPTXFEM_Field is BT.UInt16;
   ...
   type OTG_HS_DIEPEACHMSK1_Register is record
      ...
      BIM            : Boolean := False;
      --  unspecified
      Reserved_10_12 : BT.UInt3 := 16#0#;
      --  NAK interrupt mask
      NAKM           : Boolean := False;
      --  unspecified
      Reserved_14_31 : BT.UInt18 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DIEPCTL_MPSIZ_Field is BT.UInt11;
   subtype OTG_HS_DIEPCTL_EPTYP_Field is BT.UInt2;
   subtype OTG_HS_DIEPCTL_TXFNUM_Field is BT.UInt4;
   ...
   subtype OTG_HS_DIEPTSIZ0_XFRSIZ_Field is BT.UInt7;
   subtype OTG_HS_DIEPTSIZ0_PKTCNT_Field is BT.UInt2;
   ...
   type OTG_HS_DIEPTSIZ0_Register is record
      ...
      --  unspecified
      Reserved_7_18  : BT.UInt12 := 16#0#;
      --  Packet count
      PKTCNT         : OTG_HS_DIEPTSIZ0_PKTCNT_Field := 16#0#;
      --  unspecified
      Reserved_21_31 : BT.UInt11 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OTG_HS_DTXFSTS_INEPTFSAV_Field is BT.UInt16;
   ...
   subtype OTG_HS_DIEPTSIZ_XFRSIZ_Field is BT.UInt19;
   subtype OTG_HS_DIEPTSIZ_PKTCNT_Field is BT.UInt10;
   subtype OTG_HS_DIEPTSIZ_MCNT_Field is BT.UInt2;
   ...
   subtype OTG_HS_DOEPCTL0_MPSIZ_Field is BT.UInt2;
   subtype OTG_HS_DOEPCTL0_EPTYP_Field is BT.UInt2;
   ...
   type OTG_HS_DOEPCTL0_Register is record
      ...
      --  unspecified
      Reserved_2_14  : BT.UInt13 := 16#0#;
      --  Read-only. USB active endpoint
      USBAEP         : Boolean := True;
      --  unspecified
      Reserved_16_16 : BT.Bit := 16#0#;
      --  Read-only. NAK status
      NAKSTS         : Boolean := False;
      ...
      Stall          : Boolean := False;
      --  unspecified
      Reserved_22_25 : BT.UInt4 := 16#0#;
      --  Write-only. Clear NAK
      CNAK           : Boolean := False;
      --  Write-only. Set NAK
      SNAK           : Boolean := False;
      --  unspecified
      Reserved_28_29 : BT.UInt2 := 16#0#;
   ...
   subtype OTG_HS_DOEPTSIZ0_XFRSIZ_Field is BT.UInt7;
   subtype OTG_HS_DOEPTSIZ0_STUPCNT_Field is BT.UInt2;
   ...
   subtype OTG_HS_DOEPCTL_MPSIZ_Field is BT.UInt11;
   subtype OTG_HS_DOEPCTL_EPTYP_Field is BT.UInt2;
   ...
   subtype OTG_HS_DOEPTSIZ_XFRSIZ_Field is BT.UInt19;
   subtype OTG_HS_DOEPTSIZ_PKTCNT_Field is BT.UInt10;
   subtype OTG_HS_DOEPTSIZ_RXDPID_STUPCNT_Field is BT.UInt2;
   ...
   subtype OTG_HS_GAHBCFG_HBSTLEN_Field is BT.UInt4;
   ...
   subtype OTG_HS_GUSBCFG_TOCAL_Field is BT.UInt3;
   subtype OTG_HS_GUSBCFG_TRDT_Field is BT.UInt4;
   ...
   subtype OTG_HS_GRSTCTL_TXFNUM_Field is BT.UInt5;
   ...
   type OTG_HS_GRSTCTL_Register is record
      ...
      --  unspecified
      Reserved_11_29 : BT.UInt19 := 16#40000#;
   ...
   subtype OTG_HS_GRXSTSR_Host_CHNUM_Field is BT.UInt4;
   subtype OTG_HS_GRXSTSR_Host_BCNT_Field is BT.UInt11;
   subtype OTG_HS_GRXSTSR_Host_DPID_Field is BT.UInt2;
   subtype OTG_HS_GRXSTSR_Host_PKTSTS_Field is BT.UInt4;
   ...
   subtype OTG_HS_GRXSTSR_Peripheral_EPNUM_Field is BT.UInt4;
   subtype OTG_HS_GRXSTSR_Peripheral_BCNT_Field is BT.UInt11;
   subtype OTG_HS_GRXSTSR_Peripheral_DPID_Field is BT.UInt2;
   subtype OTG_HS_GRXSTSR_Peripheral_PKTSTS_Field is BT.UInt4;
   subtype OTG_HS_GRXSTSR_Peripheral_FRMNUM_Field is BT.UInt4;
   ...
   subtype OTG_HS_GRXSTSP_Host_CHNUM_Field is BT.UInt4;
   subtype OTG_HS_GRXSTSP_Host_BCNT_Field is BT.UInt11;
   subtype OTG_HS_GRXSTSP_Host_DPID_Field is BT.UInt2;
   subtype OTG_HS_GRXSTSP_Host_PKTSTS_Field is BT.UInt4;
   ...
   subtype OTG_HS_GRXSTSP_Peripheral_EPNUM_Field is BT.UInt4;
   subtype OTG_HS_GRXSTSP_Peripheral_BCNT_Field is BT.UInt11;
   subtype OTG_HS_GRXSTSP_Peripheral_DPID_Field is BT.UInt2;
   subtype OTG_HS_GRXSTSP_Peripheral_PKTSTS_Field is BT.UInt4;
   subtype OTG_HS_GRXSTSP_Peripheral_FRMNUM_Field is BT.UInt4;
   ...
   subtype OTG_HS_GRXFSIZ_RXFD_Field is BT.UInt16;
   ...
   subtype OTG_HS_GNPTXFSIZ_Host_NPTXFSA_Field is BT.UInt16;
   subtype OTG_HS_GNPTXFSIZ_Host_NPTXFD_Field is BT.UInt16;
   ...
   subtype OTG_HS_TX0FSIZ_Peripheral_TX0FSA_Field is BT.UInt16;
   subtype OTG_HS_TX0FSIZ_Peripheral_TX0FD_Field is BT.UInt16;
   ...
   subtype OTG_HS_GNPTXSTS_NPTXFSAV_Field is BT.UInt16;
   subtype OTG_HS_GNPTXSTS_NPTQXSAV_Field is BT.UInt8;
   subtype OTG_HS_GNPTXSTS_NPTXQTOP_Field is BT.UInt7;
   ...
   subtype OTG_HS_HPTXFSIZ_PTXSA_Field is BT.UInt16;
   subtype OTG_HS_HPTXFSIZ_PTXFD_Field is BT.UInt16;
   ...
   subtype OTG_HS_DIEPTXF_INEPTXSA_Field is BT.UInt16;
   subtype OTG_HS_DIEPTXF_INEPTXFD_Field is BT.UInt16;
   ...
   subtype OTG_HS_HCFG_FSLSPCS_Field is BT.UInt2;
   ...
   subtype OTG_HS_HFIR_FRIVL_Field is BT.UInt16;
   ...
   subtype OTG_HS_HFNUM_FRNUM_Field is BT.UInt16;
   subtype OTG_HS_HFNUM_FTREM_Field is BT.UInt16;
   ...
   subtype OTG_HS_HPTXSTS_PTXFSAVL_Field is BT.UInt16;
   subtype OTG_HS_HPTXSTS_PTXQSAV_Field is BT.UInt8;
   subtype OTG_HS_HPTXSTS_PTXQTOP_Field is BT.UInt8;
   ...
   subtype OTG_HS_HAINT_HAINT_Field is BT.UInt16;
   ...
   subtype OTG_HS_HAINTMSK_HAINTM_Field is BT.UInt16;
   ...
   subtype OTG_HS_HPRT_PLSTS_Field is BT.UInt2;
   subtype OTG_HS_HPRT_PTCTL_Field is BT.UInt4;
   subtype OTG_HS_HPRT_PSPD_Field is BT.UInt2;
   ...
   subtype OTG_HS_HCCHAR_MPSIZ_Field is BT.UInt11;
   subtype OTG_HS_HCCHAR_EPNUM_Field is BT.UInt4;
   subtype OTG_HS_HCCHAR_EPTYP_Field is BT.UInt2;
   subtype OTG_HS_HCCHAR_MC_Field is BT.UInt2;
   subtype OTG_HS_HCCHAR_DAD_Field is BT.UInt7;
   ...
   subtype OTG_HS_HCSPLT_PRTADDR_Field is BT.UInt7;
   subtype OTG_HS_HCSPLT_HUBADDR_Field is BT.UInt7;
   subtype OTG_HS_HCSPLT_XACTPOS_Field is BT.UInt2;
   ...
   subtype OTG_HS_HCTSIZ_XFRSIZ_Field is BT.UInt19;
   subtype OTG_HS_HCTSIZ_PKTCNT_Field is BT.UInt10;
   subtype OTG_HS_HCTSIZ_DPID_Field is BT.UInt2;
   ...
   type OTG_HS_DEVICE_Peripheral is record
      ...
      OTG_HS_DIEPDMA1     : aliased BT.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA2     : aliased BT.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA3     : aliased BT.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA4     : aliased BT.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      OTG_HS_DIEPDMA5     : aliased BT.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
   ...
   type OTG_HS_HOST_Peripheral is record
      ...
      OTG_HS_HCDMA0     : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA1     : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA2     : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA3     : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA4     : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA5     : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA6     : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA7     : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA8     : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA9     : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA10    : aliased BT.UInt32;
      ...
      OTG_HS_HCDMA11    : aliased BT.UInt32;
   end record
     with Volatile;
