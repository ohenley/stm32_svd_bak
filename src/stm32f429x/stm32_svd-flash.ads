...
package STM32_SVD.FLASH is
   ...
   subtype ACR_LATENCY_Field is BT.UInt3;
   ...
   subtype CR_SNB_Field is BT.UInt5;
   subtype CR_PSIZE_Field is BT.UInt2;
   ...
   type CR_Register is record
      ...
      STRT           : Boolean := False;
      --  unspecified
      Reserved_17_23 : BT.UInt7 := 16#0#;
      --  End of operation interrupt enable
      EOPIE          : Boolean := False;
      --  Error interrupt enable
      ERRIE          : Boolean := False;
      --  unspecified
      Reserved_26_30 : BT.UInt5 := 16#0#;
      --  Lock
      LOCK           : Boolean := True;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype OPTCR_BOR_LEV_Field is BT.UInt2;
   subtype OPTCR_RDP_Field is BT.UInt8;
   subtype OPTCR_nWRP_Field is BT.UInt12;
   ...
   subtype OPTCR1_nWRP_Field is BT.UInt12;
   ...
   type FLASH_Peripheral is record
      ...
      --  Flash key register
      KEYR    : aliased BT.UInt32;
      --  Flash option key register
      OPTKEYR : aliased BT.UInt32;
      --  Status register
