...
package STM32_SVD.DBG is
   ...
   subtype DBGMCU_IDCODE_DEV_ID_Field is BT.UInt12;
   subtype DBGMCU_IDCODE_REV_ID_Field is BT.UInt16;
   ...
   subtype DBGMCU_CR_TRACE_MODE_Field is BT.UInt2;
